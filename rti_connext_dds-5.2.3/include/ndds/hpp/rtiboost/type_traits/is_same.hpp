...
#ifndef RTIBOOST_TT_IS_SAME_HPP_INCLUDED
#define RTIBOOST_TT_IS_SAME_HPP_INCLUDED
...
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,false)
RTIBOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename T,is_same,T,T,true)
...
struct is_same_impl
{
    enum { value = rtiboost::detail::is_same_part_1<T1>::template part_2<T2>::value };
};

#else // generic "no-partial-specialization" version

template <typename T>
::rtiboost::type_traits::yes_type
RTIBOOST_TT_DECL is_same_tester(T*, T*);

::rtiboost::type_traits::no_type
RTIBOOST_TT_DECL is_same_tester(...);
...
struct is_same_impl
{
   ...
   RTIBOOST_STATIC_CONSTANT(bool, value =
      (::rtiboost::type_traits::ice_and<
         (sizeof(type_traits::yes_type) == sizeof(rtiboost::detail::is_same_tester(&t,&u))),
         (::rtiboost::is_reference<T>::value == ::rtiboost::is_reference<U>::value),
         (sizeof(T) == sizeof(U))
        >::value));
};
...
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF2(is_same,T,U,(::rtiboost::detail::is_same_impl<T,U>::value))
...
#endif  // RTIBOOST_TT_IS_SAME_HPP_INCLUDED
