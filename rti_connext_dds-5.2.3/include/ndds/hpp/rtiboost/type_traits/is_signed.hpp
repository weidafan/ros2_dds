...
struct is_signed_imp
{
   ...
   RTIBOOST_STATIC_CONSTANT(bool, value = is_signed_imp<T>::type::value);
#else
...
#if defined( __CODEGEARC__ )
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,__is_signed(T))
#else
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,::rtiboost::detail::is_signed_imp<T>::value)
#endif
