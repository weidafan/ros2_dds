...
#ifndef RTIBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
#define RTIBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
no_type RTIBOOST_TT_DECL is_function_ptr_tester(...);
...
#define RTIBOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "rtiboost/type_traits/detail/is_function_ptr_tester.hpp"))
...
#endif // RTIBOOST_TT_DETAIL_IS_FUNCTION_PTR_TESTER_HPP_INCLUDED
...
yes_type is_function_ptr_tester(R (*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T)));
@#ifndef RTIBOOST_TT_NO_ELLIPSIS_IN_FUNC_TESTING
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T) ...));
@#endif
@#ifdef RTIBOOST_TT_TEST_MS_FUNC_SIGS
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T)));
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__stdcall*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T) ...));
@#ifndef _MANAGED
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T)));
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__fastcall*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T) ...));
@#endif
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T)));
template <class R RTIBOOST_PP_COMMA_IF(RTIBOOST_PP_COUNTER) RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,class T) >
yes_type is_function_ptr_tester(R (__cdecl*)(RTIBOOST_PP_ENUM_PARAMS(RTIBOOST_PP_COUNTER,T) ...));
@#endif
