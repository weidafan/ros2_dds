...
#ifndef RTIBOOST_TT_HAS_MULTIPLIES_ASSIGN_HPP_INCLUDED
#define RTIBOOST_TT_HAS_MULTIPLIES_ASSIGN_HPP_INCLUDED

#define RTIBOOST_TT_TRAIT_NAME has_multiplies_assign
