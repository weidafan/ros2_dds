...
#ifndef RTI_FILE_boost_type_traits_integral_promotion_hpp_INCLUDED
#define RTI_FILE_boost_type_traits_integral_promotion_hpp_INCLUDED
...
struct integral_promotion
  : public rtiboost::mpl::eval_if<
        need_promotion<RTIBOOST_DEDUCED_TYPENAME remove_cv<T>::type>
      , integral_promotion_impl<T>
      , rtiboost::mpl::identity<T>
      >
{
};
...
RTIBOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , RTIBOOST_DEDUCED_TYPENAME
        rtiboost::type_traits::detail::integral_promotion<T>::type
    )
}
