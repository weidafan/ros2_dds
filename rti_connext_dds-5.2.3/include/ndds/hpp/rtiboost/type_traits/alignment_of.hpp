...
#include <rtiboost/type_traits/detail/size_t_trait_def.hpp>
...
RTIBOOST_TT_AUX_SIZE_T_TRAIT_DEF1(alignment_of,T,::rtiboost::detail::alignment_of_impl<T>::value)
...
RTIBOOST_TT_AUX_SIZE_T_TRAIT_SPEC1(alignment_of,void,0)
#ifndef RTIBOOST_NO_CV_VOID_SPECIALIZATIONS
RTIBOOST_TT_AUX_SIZE_T_TRAIT_SPEC1(alignment_of,void const,0)
RTIBOOST_TT_AUX_SIZE_T_TRAIT_SPEC1(alignment_of,void volatile,0)
RTIBOOST_TT_AUX_SIZE_T_TRAIT_SPEC1(alignment_of,void const volatile,0)
#endif
...
#include <rtiboost/type_traits/detail/size_t_trait_undef.hpp>
