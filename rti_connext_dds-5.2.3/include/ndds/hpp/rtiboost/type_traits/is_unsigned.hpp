...
#ifndef RTIBOOST_TT_IS_UNSIGNED_HPP_INCLUDED
#define RTIBOOST_TT_IS_UNSIGNED_HPP_INCLUDED
...
#if !(defined(__EDG_VERSION__) && __EDG_VERSION__ <= 238) && !defined(RTIBOOST_NO_INCLASS_MEMBER_INITIALIZATION)
...
{
   RTIBOOST_STATIC_CONSTANT(bool, value = (::rtiboost::detail::is_unsigned_values<T>::minus_one > ::rtiboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned_imp
{
   typedef is_ununsigned_select_helper< 
      ::rtiboost::type_traits::ice_or<
         ...
         ::rtiboost::is_enum<T>::value>::value 
   > selector;
...
#endif
#if defined(WCHAR_MIN) && (WCHAR_MIN == 0) && !defined(RTIBOOST_NO_INTRINSIC_WCHAR_T)
...
#if defined( __CODEGEARC__ )
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,__is_unsigned(T))
#else
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::rtiboost::detail::is_unsigned_imp<T>::value)
#endif
