...
#ifndef RTIBOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED
#define RTIBOOST_TT_HAS_PLUS_ASSIGN_HPP_INCLUDED

#define RTIBOOST_TT_TRAIT_NAME has_plus_assign
...
#define RTIBOOST_TT_FORBIDDEN_IF\
   ::rtiboost::type_traits::ice_or<\
      ...
      ::rtiboost::type_traits::ice_and<\
         ::rtiboost::is_pointer< Rhs_noref >::value,\
         ::rtiboost::is_fundamental< Lhs_nocv >::value,\
         ::rtiboost::type_traits::ice_not< ::rtiboost::is_same< Lhs_nocv, bool >::value >::value\
      >::value,\
