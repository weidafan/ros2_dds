...
#ifndef RTIBOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define RTIBOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED

#include <rtiboost/type_traits/intrinsics.hpp>
#ifndef RTIBOOST_IS_BASE_OF
...
#ifndef RTIBOOST_IS_BASE_OF
#if !RTIBOOST_WORKAROUND(__BORLANDC__, RTIBOOST_TESTED_AT(0x581)) \
 && !RTIBOOST_WORKAROUND(__SUNPRO_CC , <= 0x540) \
...
#pragma warning(disable:6334)
    ...
    //
    RTIBOOST_STATIC_ASSERT(sizeof(B) != 0);
    RTIBOOST_STATIC_ASSERT(sizeof(D) != 0);
...
{
    RTIBOOST_STATIC_CONSTANT(bool, value =
        (::rtiboost::is_convertible<D*,B*>::value));
};

#define RTIBOOST_BROKEN_IS_BASE_AND_DERIVED
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::rtiboost::is_class<B>::value,
       ::rtiboost::is_class<D>::value,
       ::rtiboost::is_same<ncvB,ncvD>::value> selector;
    typedef typename selector::template rebind<ncvB,ncvD> binder;
    typedef typename binder::type bound_type;

    RTIBOOST_STATIC_CONSTANT(bool, value = bound_type::value);
};
#else
template <typename B, typename D>
struct is_base_and_derived_impl
{
    ...
    RTIBOOST_STATIC_CONSTANT(bool, value = (RTIBOOST_IS_BASE_OF(B,D) && ! ::rtiboost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::rtiboost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )

#ifndef RTIBOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
RTIBOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived,false)
RTIBOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base,Derived&,false)
RTIBOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived&,false)
#endif

#if RTIBOOST_WORKAROUND(__CODEGEARC__, RTIBOOST_TESTED_AT(0x610))
RTIBOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename Base,is_base_and_derived,Base,Base,false)
#endif
