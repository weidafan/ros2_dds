...
#ifndef RTIBOOST_TT_HAS_RIGHT_SHIFT_ASSIGN_HPP_INCLUDED
#define RTIBOOST_TT_HAS_RIGHT_SHIFT_ASSIGN_HPP_INCLUDED

#define RTIBOOST_TT_TRAIT_NAME has_right_shift_assign
