...
struct has_trivial_move_assign_impl
{
   ...
   RTIBOOST_STATIC_CONSTANT(bool, value = (RTIBOOST_HAS_TRIVIAL_MOVE_ASSIGN(T)));
#else
   RTIBOOST_STATIC_CONSTANT(bool, value =
           (::rtiboost::type_traits::ice_and<
              ::rtiboost::is_pod<T>::value,
              ::rtiboost::type_traits::ice_not< ::rtiboost::is_const<T>::value >::value,
...
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_move_assign,T,::rtiboost::detail::has_trivial_move_assign_impl<T>::value)
RTIBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_assign,void,false)
#ifndef RTIBOOST_NO_CV_VOID_SPECIALIZATIONS
RTIBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_assign,void const,false)
RTIBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_assign,void const volatile,false)
RTIBOOST_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_move_assign,void volatile,false)
#endif
