...
#ifndef RTIBOOST_TT_HAS_LEFT_SHIFT_ASSIGN_HPP_INCLUDED
#define RTIBOOST_TT_HAS_LEFT_SHIFT_ASSIGN_HPP_INCLUDED

#define RTIBOOST_TT_TRAIT_NAME has_left_shift_assign
