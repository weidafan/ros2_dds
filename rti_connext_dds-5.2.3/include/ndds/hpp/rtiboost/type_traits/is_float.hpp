...
RTIBOOST_TT_AUX_BOOL_TRAIT_DEF1(is_float,T,false)
RTIBOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_float,float,true)
RTIBOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_float,double,true)
RTIBOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_float,long double,true)
