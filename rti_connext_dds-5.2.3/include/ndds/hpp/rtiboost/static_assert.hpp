...
#  define RTIBOOST_STATIC_ASSERT_UNUSED_ATTRIBUTE __attribute__((unused))
#else
#  define RTIBOOST_STATIC_ASSERT_UNUSED_ATTRIBUTE
#endif
...
#elif defined(RTIBOOST_MSVC) && defined(RTIBOOST_NO_CXX11_VARIADIC_MACROS)
#define RTIBOOST_STATIC_ASSERT( B ) \
   typedef ::rtiboost::static_assert_test<\
...
#define RTIBOOST_STATIC_ASSERT( B ) \
   RTIBOOST_STATIC_CONSTANT(int, \s
     RTIBOOST_JOIN(boost_static_assert_test_, __LINE__) = \
       sizeof(::rtiboost::STATIC_ASSERTION_FAILURE< RTIBOOST_STATIC_ASSERT_BOOL_CAST( B ) >) )
#else
// generic version
...
#     define RTIBOOST_STATIC_ASSERT( ... ) \
         typedef ::rtiboost::static_assert_test<\
            sizeof(::rtiboost::STATIC_ASSERTION_FAILURE< RTIBOOST_STATIC_ASSERT_BOOL_CAST( __VA_ARGS__ ) >)>\
               RTIBOOST_JOIN(boost_static_assert_typedef_, __LINE__) RTIBOOST_STATIC_ASSERT_UNUSED_ATTRIBUTE
#  else
#     define RTIBOOST_STATIC_ASSERT( B ) \
         typedef ::rtiboost::static_assert_test<\
            sizeof(::rtiboost::STATIC_ASSERTION_FAILURE< RTIBOOST_STATIC_ASSERT_BOOL_CAST( B ) >)>\
