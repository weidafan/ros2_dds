...
#     define RTIBOOST_NO_LIMITS
// Note: <rtiboost/limits.hpp> will provide compile-time constants
#     undef RTIBOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#define RTIBOOST_STDLIB "SGI standard library"
