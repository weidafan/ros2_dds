...
//
#if __SUNPRO_CC > 0x500
#  define RTIBOOST_SYMBOL_EXPORT __global
#  define RTIBOOST_SYMBOL_IMPORT __global
#  define RTIBOOST_SYMBOL_VISIBLE __global
#endif
...
#define RTIBOOST_COMPILER "Sun compiler version " RTIBOOST_STRINGIZE(__SUNPRO_CC)
