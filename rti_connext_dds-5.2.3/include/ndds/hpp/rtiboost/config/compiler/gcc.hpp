...
//
// Define RTIBOOST_GCC so we know this is "real" GCC and not some pretender:
//
#if !defined(__CUDACC__)
#define RTIBOOST_GCC (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif
...
#if !defined(__EXCEPTIONS) && !defined(RTIBOOST_NO_EXCEPTIONS)
...
#    define RTIBOOST_SYMBOL_EXPORT __attribute__((__dllexport__))
#    define RTIBOOST_SYMBOL_IMPORT __attribute__((__dllimport__))
#  else
...
#  ifndef __GXX_RTTI
#     ifndef RTIBOOST_NO_TYPEID
#        define RTIBOOST_NO_TYPEID
#     endif
#     ifndef RTIBOOST_NO_RTTI
...
#if !defined(RTIBOOST_NO_CXX11_DEFAULTED_FUNCTIONS) && (__GNUC__ == 4 && __GNUC_MINOR__ <= 5)
...
// scoped enums have a serious bug in 4.4.0, so define RTIBOOST_NO_CXX11_SCOPED_ENUMS before 4.5.1
...
#  define RTIBOOST_COMPILER "GNU C++ version " __VERSION__
#endif

// ConceptGCC compiler:
//   http://www.generic-programming.org/software/ConceptGCC/
#ifdef __GXX_CONCEPTS__
#  define RTIBOOST_HAS_CONCEPTS
#  define RTIBOOST_COMPILER "ConceptGCC version " __VERSION__
#endif
