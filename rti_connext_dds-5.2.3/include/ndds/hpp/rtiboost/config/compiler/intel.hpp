...
#if defined(RTIBOOST_INTEL_STDCXX0X) && (RTIBOOST_INTEL_CXX_VERSION >= 1200)
//#  undef  RTIBOOST_NO_CXX11_RVALUE_REFERENCES // Enabling this breaks Filesystem and Exception libraries
//#  undef  RTIBOOST_NO_CXX11_SCOPED_ENUMS  // doesn't really work!!
...
#endif
#if defined(RTIBOOST_INTEL_STDCXX0X) && (RTIBOOST_INTEL_CXX_VERSION >= 1310) && !defined(_MSC_VER)
...
#  undef  RTIBOOST_NO_SFINAE_EXPR
#endif
#if defined(RTIBOOST_INTEL_STDCXX0X) && (RTIBOOST_INTEL_CXX_VERSION >= 1400) && !defined(_MSC_VER)
...
//#  undef RTIBOOST_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS 
#  undef RTIBOOST_NO_CXX11_HDR_THREAD 
...
#if defined(__LP64__) && defined(__GNUC__) && (RTIBOOST_INTEL_CXX_VERSION >= 1310)
