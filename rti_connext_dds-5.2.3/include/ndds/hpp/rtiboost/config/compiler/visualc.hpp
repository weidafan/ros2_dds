...
//
// Helper macro RTIBOOST_MSVC_FULL_VER for use in Boost code:
//
#if _MSC_FULL_VER > 100000000
#  define RTIBOOST_MSVC_FULL_VER _MSC_FULL_VER
#else
#  define RTIBOOST_MSVC_FULL_VER (_MSC_FULL_VER * 10)
#endif
...
#  define RTIBOOST_NO_MEMBER_TEMPLATE_FRIENDS
   ...
   // A bug in VC9:
#  define RTIBOOST_NO_ADL_BARRIER
#endif
...
// turned off:
//
#if !defined(_MSC_EXTENSIONS) && !defined(RTIBOOST_DISABLE_WIN32)
#  define RTIBOOST_DISABLE_WIN32
#endif
#if !defined(_CPPRTTI) && !defined(RTIBOOST_NO_RTTI)
...
//
#if _MSC_VER >= 1700
// # define RTIBOOST_HAS_TR1_HASH			// don't know if this is true yet.
// # define RTIBOOST_HAS_TR1_TYPE_TRAITS	// don't know if this is true yet.
...
#  define RTIBOOST_ABI_PREFIX "rtiboost/config/abi/msvc_prefix.hpp"
#endif
#ifndef RTIBOOST_ABI_SUFFIX
#  define RTIBOOST_ABI_SUFFIX "rtiboost/config/abi/msvc_suffix.hpp"
#endif
...
#      endif
#   elif _MSC_VER < 1500
#     define RTIBOOST_COMPILER_VERSION evc8
#   elif _MSC_VER < 1600
#     define RTIBOOST_COMPILER_VERSION evc9
#   elif _MSC_VER < 1700
#     define RTIBOOST_COMPILER_VERSION evc10
#   elif _MSC_VER < 1800 
#     define RTIBOOST_COMPILER_VERSION evc11 
#   elif _MSC_VER < 1900 
#     define RTIBOOST_COMPILER_VERSION evc12
#   else
#      if defined(RTIBOOST_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
#     define RTIBOOST_COMPILER_VERSION 5.0
#   elif _MSC_VER < 1300
#     define RTIBOOST_COMPILER_VERSION 6.0
#   elif _MSC_VER < 1310
#     define RTIBOOST_COMPILER_VERSION 7.0
#   elif _MSC_VER < 1400
#     define RTIBOOST_COMPILER_VERSION 7.1
#   elif _MSC_VER < 1500
#     define RTIBOOST_COMPILER_VERSION 8.0
#   elif _MSC_VER < 1600
#     define RTIBOOST_COMPILER_VERSION 9.0
#   elif _MSC_VER < 1700
#     define RTIBOOST_COMPILER_VERSION 10.0
#   elif _MSC_VER < 1800 
#     define RTIBOOST_COMPILER_VERSION 11.0
#   elif _MSC_VER < 1900
#     define RTIBOOST_COMPILER_VERSION 12.0
#   elif _MSC_VER < 2000
#     define RTIBOOST_COMPILER_VERSION 14.0
#   else
#     define RTIBOOST_COMPILER_VERSION _MSC_VER
#   endif
# endif

#  define RTIBOOST_COMPILER "Microsoft Visual C++ version " RTIBOOST_STRINGIZE(RTIBOOST_COMPILER_VERSION)
#endif

//
// last known and checked version is 19.00.23506 (VC13 RC, aka VS2015 Update1):
