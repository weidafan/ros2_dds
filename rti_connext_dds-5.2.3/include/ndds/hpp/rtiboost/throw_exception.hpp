...
#include <rtiboost/exception/detail/attribute_noreturn.hpp>
...
template<class E> RTIBOOST_ATTRIBUTE_NORETURN inline void throw_exception( E const & e )
{
