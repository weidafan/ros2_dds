...
#if defined(RTIBOOST_NO_MEMBER_TEMPLATES) && !defined(RTIBOOST_MSVC6_MEMBER_TEMPLATES)
#include <rtiboost/smart_ptr/detail/shared_ptr_nmt.hpp>
#else
...
#include <rtiboost/memory_order.hpp>
#endif
...
{
    return rtiboost::hash< T* >()( p.get() );
}

} // namespace rtiboost

#endif  // #if defined(RTIBOOST_NO_MEMBER_TEMPLATES) && !defined(RTIBOOST_MSVC6_MEMBER_TEMPLATES)
