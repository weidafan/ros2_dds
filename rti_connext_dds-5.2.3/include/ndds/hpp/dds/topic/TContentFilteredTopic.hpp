...
public:
     ...
     * @param name Name for the new content filtered topic, must not exceed
     *             255 characters.
    ...
    ContentFilteredTopic(
        ...
        : TopicDescription<T, DELEGATE>(new DELEGATE<T>(topic, name, filter))
    {
    ...
    ContentFilteredTopic(dds::core::construct_from_native_tag_t, DELEGATE<T>* delegate)
