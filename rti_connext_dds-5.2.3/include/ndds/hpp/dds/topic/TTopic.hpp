...
public:
    ...
    Topic(
        ...
        : TopicDescription<T, DELEGATE>(new DELEGATE<T>(participant, topic_name))
    {
     ...
     * @param topic_name The topic name.
     * @param type_name The name to register the type with
     */
    Topic(
        ...
        : TopicDescription<T, DELEGATE>(
            new DELEGATE<T>(dp, topic_name, type_name))
    {
        this->delegate()->remember_reference(this->delegate());
    }
    ...
    Topic(
        ...
        : TopicDescription<T, DELEGATE>(
            new DELEGATE<T>(dp, topic_name, qos, listener, mask))
     {
        this->delegate()->remember_reference(this->delegate());
     }
     ...
     * @param qos The Qos settings for this Topic
     * @param listener the topic listener (default: NULL)
    ...
    Topic(
        ...
        const dds::core::status::StatusMask& mask =
            dds::core::status::StatusMask::all())
        : TopicDescription<T, DELEGATE>(
            new DELEGATE<T>(participant, topic_name, type_name, qos, listener, mask))
    {
        this->delegate()->remember_reference(this->delegate());
    }
    ...
    Topic(dds::core::construct_from_native_tag_t, DELEGATE<T>* delegate)
        : TopicDescription<T, DELEGATE>(delegate)
    {
        this->delegate()->remember_reference(this->delegate());
    }

    // Spec issue: need to define operator explicitly
    Topic& operator=(dds::core::null_type)
    {
        dds::core::TEntity<DELEGATE<T> >::operator =(dds::core::null);
        return *this;
    }
     ...
     *  
     * @see Topic(const dds::domain::DomainParticipant& participant,
        const std::string& topic_name,
    ...
    Topic(
        ...
        const std::string& topic_name,
        const dds::core::xtypes::DynamicType& type)
        : TopicDescription<T, DELEGATE>(new DELEGATE<T>(participant, topic_name, type))
    {
        this->delegate()->remember_reference(this->delegate());
    }
    ...
    Topic(const dds::domain::DomainParticipant& participant,
        ...
        const dds::core::status::StatusMask& mask = dds::core::status::StatusMask::all())
            : TopicDescription<T, DELEGATE>(new DELEGATE<T>(
                participant, topic_name, type, qos, listener, mask))
    {
        this->delegate()->remember_reference(this->delegate());
    }
