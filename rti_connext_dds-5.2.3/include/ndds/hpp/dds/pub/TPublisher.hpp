...
public:
    ...
    *
    * @param participant The DomainParticipant where this Publisher will be created
    */
    explicit TPublisher(const dds::domain::DomainParticipant& participant)
    ...
    *
    * @param participant The DomainParticipant where this Publisher will be created
    * @param qos The PublisherQos
    * @param listener The PublisherListener
    ...
    */
    TPublisher(
        ...
        : dds::core::TEntity<DELEGATE>(new DELEGATE(participant, qos, listener, mask))
    {
        this->delegate()->remember_reference(this->delegate());
    }
    ...
    TPublisher(dds::core::construct_from_native_tag_t, DELEGATE* delegate)
    ...
    {
        this->delegate()->wait_for_acknoledgments(max_wait);
    }
