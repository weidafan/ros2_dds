...
public:
  ...
  DataWriter(
      ...
      : dds::core::TEntity<DELEGATE<T> >(new DELEGATE<T>(pub, topic))
   {
   ...
   * @param pub The publisher that this DataWriter belongs to
   * @param topic The Topic associated with this DataWriter
   * @param qos QoS to be used for creating the new Datawriter.
   * @param listener The DataWriter listener. The caller owns the listener and
  ...
  DataWriter(dds::core::construct_from_native_tag_t, DELEGATE<T>* delegate)
  ...
  // Spec error: need this operator
  DataWriter& operator=(dds::core::null_type)
  {
 ...
 */
  ...
  DataWriter& dispose_instance(
      ...
      const dds::core::Time& source_timestamp)
  {
      this->delegate()->dispose_instance(instance_handle, source_timestamp);
      return *this;
  }
