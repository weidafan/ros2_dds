...
public:
  ...
  public:
    ...
    */
    ...
    TUserData& value(OctetIter begin, OctetIter end)
    {
        this->delegate().value(begin, end);
        return *this;
    }
 ...
 * @headerfile dds/core/policy/CorePolicy.hpp
 * @brief Configures an dds::core::Entity that acts as factory of other entities
 *
...
public:
    ...
    explicit TTypeConsistencyEnforcement(
       dds::core::policy::TypeConsistencyEnforcementKind kind)
