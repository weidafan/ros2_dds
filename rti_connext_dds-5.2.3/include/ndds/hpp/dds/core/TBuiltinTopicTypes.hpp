...
public:
     ...
     *  
     */ 
    TStringTopicType(const dds::core::string& data)
        : dds::core::Value<DELEGATE>(data)
    {
    }
     ...
     * \endcode
     *
     * @param data The string to be copied to create this instance
     */
     ...
     *  
     */
    TStringTopicType(const char * data)
        : dds::core::Value<DELEGATE>(dds::core::string(data))
    {
    }
...
public:
    ...
    TKeyedStringTopicType(
        const dds::core::string& key, const dds::core::string& value)
