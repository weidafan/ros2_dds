 ...
 */
#define OMG_DDS_REF_TYPE_BASE_TYPENAME(TYPE, BASE, DELEGATE, TYPENAME_KEYWORD)     \
    public: \
    typedef BASE< DELEGATE > BASE_T;\
    public: /* Spec error: was protected; needs to be public*/ \
    explicit TYPE(DELEGATE_T* p)\
    : BASE< DELEGATE_T >(p) \
      {  }\
    public:\
    ...
    : BASE< DELEGATE_T >(h) \
      ...
      OMG_DDS_STATIC_ASSERT(\
          (::dds::core::is_base_of<TYPENAME_KEYWORD TYPE::DELEGATE_T, typename H__::DELEGATE_T>::value),\
...
#define OMG_DDS_REF_TYPE_BASE(TYPE, BASE, DELEGATE)     \
    OMG_DDS_REF_TYPE_BASE_TYPENAME(TYPE, BASE, DELEGATE, typename)
...
#define OMG_DDS_REF_TYPE_BASE_T(TYPE, BASE, T_PARAM, DELEGATE) \
    ...
    : BASE< T_PARAM, DELEGATE >(h) \
      { \
      OMG_DDS_STATIC_ASSERT(\
          (::dds::core::is_base_of<typename TYPE::DELEGATE_T, typename H__::DELEGATE_T>::value),\
          "Delegate types must have an inheritance relationship"); \
      this->::dds::core::Reference< DELEGATE< T_PARAM > >::impl_ = h.delegate(); \
      }


#define OMG_DDS_REF_TYPE_DELEGATE_TYPENAME(TYPE, BASE, DELEGATE, TYPENAME_KEYWORD)     \
    public: \
    typedef DELEGATE                                                          DELEGATE_T;   \
    typedef TYPENAME_KEYWORD ::dds::core::smart_ptr_traits< DELEGATE >::ref_type      DELEGATE_REF_T; \
    typedef TYPENAME_KEYWORD ::dds::core::smart_ptr_traits< DELEGATE >::weak_ref_type DELEGATE_WEAK_REF_T; \
    \
    private:\
    const TYPENAME_KEYWORD ::dds::core::Reference< DELEGATE >::DELEGATE_REF_T& impl() const \
    { return ::dds::core::Reference< DELEGATE >::impl_; }\
    TYPENAME_KEYWORD ::dds::core::Reference< DELEGATE >::DELEGATE_REF_T& impl() \
    { return ::dds::core::Reference< DELEGATE >::impl_; }\
    \
    public:\
    ...
    operator=(const T__& rhs) {\
      OMG_DDS_STATIC_ASSERT((::dds::core::is_base_of<TYPENAME_KEYWORD TYPE::DELEGATE_T, typename T__::DELEGATE_T>::value),\
         "Delegate types must have an inheritance relationship");\
      if (this != (TYPE*)&rhs) \
      *this = TYPE(rhs); \
      return *this; \
...
#define OMG_DDS_REF_TYPE_DELEGATE(TYPE, BASE, DELEGATE) \
    OMG_DDS_REF_TYPE_DELEGATE_TYPENAME(TYPE, BASE, DELEGATE, typename)
...
#define DDS_PTR_CTOR_REF_TYPE(TYPE, BASE, DELEGATE)     \
    ...
    : BASE< DELEGATE_T >(p) \
      ...
      explicit TYPE(PTR* ptr) {\
        OMG_DDS_STATIC_ASSERT(\
            (::dds::core::is_base_of<typename TYPE::DELEGATE_T, PTR>::value),\
            "Delegate types must have an inheritance relationship"); \
    ...
    operator=(const T__& rhs) {\
      OMG_DDS_STATIC_ASSERT(\
          (::dds::core::is_base_of<typename TYPE::DELEGATE_T, typename T__::DELEGATE_T>::value),\
          "Delegate types must have an inheritance relationship");\
      if (this != (TYPE*)&rhs) \
      *this = TYPE(rhs); \
      return *this; \
...
#define OMG_DDS_REF_TYPE_NOTYPENAME(TYPE, BASE, DELEGATE)                  \
    OMG_DDS_REF_TYPE_DELEGATE_TYPENAME(TYPE, BASE, DELEGATE,)              \
    OMG_DDS_REF_TYPE_BASE_TYPENAME(TYPE, BASE, DELEGATE,)                  \
    private: \
    TYPE();  \
    public:  \
    TYPE(const dds::core::null_type&) : BASE< DELEGATE >(static_cast<DELEGATE*>(NULL)) { }
