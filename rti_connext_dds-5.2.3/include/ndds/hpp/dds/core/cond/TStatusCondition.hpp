...
public:
     ...
     *
     * @param entity The Entity whose status condition we're getting a reference to.
     ...
     */
    TStatusCondition(const dds::core::Entity& entity)
        : TCondition<DELEGATE>(entity->status_condition_ref())
    {
    }
