...
public:
    ...
    /**
     * @brief Default constructor doesn't initialize the underlying enumeration.
     *
     * For consistency with the behavior of C++11 class enum, this constructor
     * doesn't initialize the enumeration.
     */
    safe_enum() {} // same behavior as C++11 class enums: do not initialize value
    ...
    /**
     * @brief Retrives the actual enumeration value
     */
