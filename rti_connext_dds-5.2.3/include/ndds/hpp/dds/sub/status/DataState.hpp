...
public:
     ...
     */
    /* implicit */ DataState(const SampleState& sample_state)
     ...
     * wherever a DataState is expected.
     */
    /* implicit */ DataState(const ViewState& view_state)
        : sample_state_(SampleState::any()),
     ...
     * wherever a DataState is expected.
     */
    /* implicit */ DataState(const InstanceState& instance_state)
        : sample_state_(SampleState::any()),
          view_state_(ViewState::any()),
     ...
     */
    DataState(
        const SampleState& sample_state,
        const ViewState& view_state,
        const InstanceState& instance_state) :
        sample_state_(sample_state), view_state_(view_state),
            instance_state_(instance_state)
    {
    }
    ...
    const DataState& operator >>(
        SampleState& sample_state) const
    {
        sample_state = sample_state_;
        return *this;
    }
