...
public:
    ...
    explicit TDomainParticipant(int32_t domain_id)
        : dds::core::TEntity<DELEGATE>(new DELEGATE(domain_id))
    {
    ...
    *
    * @param domain_id the id of the domain joined by this DomainParticipant.
    *        \range [>=0], and does not violate guidelines stated in
    *        \idref_RtpsWellKnownPorts_t.
    * @param qos The QoS settings for this DomainParticipant. See also set_qos().
    * @param listener The listener (NULL by default)
    ...
    */
    TDomainParticipant(
      ...
      : dds::core::TEntity<DELEGATE>(
          new DELEGATE(domain_id, qos, listener, mask))
    {
        this->delegate()->remember_reference(this->delegate());
    }
    ...
    TDomainParticipant(
        dds::core::construct_from_native_tag_t, DELEGATE* delegate)
        : dds::core::TEntity<DELEGATE>(delegate)
    {
        this->delegate()->remember_reference(this->delegate());
    }

    // Spec error CPPPSM-18: need this constructor to make polymorphic_cast work
    TDomainParticipant(
...
public:
     ...
     * of a type that for which other global or static variables exist.
     */
     ...
     * default QoS values. 
     *  
     * @param qos The PublisherQos to set.
     ...
     *  
     * @param qos The SubscriberQos to set.
     * @throw One of the standard @ref DDSException, 
     * or dds::core::InconsistentPolicyError
     */
