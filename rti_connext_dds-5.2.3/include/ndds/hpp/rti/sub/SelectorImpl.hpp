...
public:
    ...
    DefaultSelector& max_samples(int32_t max_samples)
    {
        state_.max_samples = max_samples;
        return *this;
    }
...
public:
    ...
    Selector& condition(const dds::sub::cond::ReadCondition& condition)
    {
        state_.condition = condition.delegate();
    ...
    Selector& max_samples(int32_t max_samples)
    {
        state_.max_samples = max_samples;
        return *this;
    }
    ...
    uint32_t read(SamplesFWIterator sfit, int32_t max_samples)
    {
        ...
        tmp_state.max_samples = max_samples;
