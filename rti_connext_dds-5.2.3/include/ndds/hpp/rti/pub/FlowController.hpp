...
public:
     ...
     *
     * @param participant The DomainParticipant where this FlowController exists
     * @param name Name to refer to this FlowController
     * @param property Determines how to shape the network traffic
     *
    ...
    FlowController(
        dds::domain::DomainParticipant participant,
        const std::string& name,
        const FlowControllerProperty& property = FlowControllerProperty())
        : Base(new FlowControllerImpl(participant, name, property))
    {
