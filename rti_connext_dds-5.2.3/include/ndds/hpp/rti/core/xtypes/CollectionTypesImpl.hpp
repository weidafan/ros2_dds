...
public:
     ...
     * @param bounds The maximum length
     */
    SequenceTypeImpl(dds::core::xtypes::DynamicType&& type, uint32_t bounds)
    {
        initialize(&type, bounds, false);
    }
  #endif
...
public:
     ...
     *
     * @param type The element type
     * @param dimension The dimension of this unidimensional array
     */
    ArrayTypeImpl(
        const dds::core::xtypes::DynamicType& type, uint32_t dimension)
    {
        initialize(&type, DimensionsSeq(1, dimension));
    }
     ...
     * @param dimension The dimension of this unidimensional array
     */
    ArrayTypeImpl(dds::core::xtypes::DynamicType&& type, uint32_t dimension)
    {
        initialize(&type, DimensionsSeq(1, dimension), false);
    }
