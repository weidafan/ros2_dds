...
public:
    ...
    {
        initialize(name, discriminator_type);
    }
     ...
     * @param members A container with the members for this union type
     */
     ...
     * @param name The name of the type
     * @param discriminator_type The type of the discriminator
     * @param members An ininitalizer_list of UnionMembers
     */
    UnionTypeImpl(
        const std::string& name,
        const DynamicTypeImpl& discriminator_type,
     ...
     */
    template <typename Container>
    UnionTypeImpl& add_members(const Container& members)
    {
     ...
     */
    UnionTypeImpl& add_members(std::initializer_list<UnionMember> members)
    {
        return add_members(members.begin(), members.end());
    }
  #endif
     ...
     */
    UnionTypeImpl& add_member(UnionMember&& member)
    {
        return add_member_impl(member, true);
    }
  #endif
