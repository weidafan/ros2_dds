...
public:
    ...
    /**
      ...
      * @param name The name of the type
      * @param members A container with the members for this enum type
      */
     template <typename Container>
     EnumTypeImpl(const std::string& name, const Container& members)
     {
         initialize(name);
         add_members(members);
     }
     ...
     EnumTypeImpl(const std::string& name, MemberIter begin, MemberIter end)
     {
         initialize(name);
      ...
      *
      * @param name The name of the type
      * @param members An ininitalizer_list of EnumMembers
      */
     EnumTypeImpl(
         const std::string& name, std::initializer_list<EnumMemberImpl> members)
     {
         initialize(name);
         add_members(members);
     }
     ...
     */
    template<typename Container>
    EnumTypeImpl& add_members(const Container& members)
    {
     ...
     */
    EnumTypeImpl& add_members(std::initializer_list<EnumMemberImpl> members)
    {
        return add_members(members.begin(), members.end());
    }
#endif
