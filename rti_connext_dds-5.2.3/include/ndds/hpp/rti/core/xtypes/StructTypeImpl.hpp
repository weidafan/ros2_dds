...
public:
     ...
     * @param name The name of the type
     * @param members A container with the members for this struct type
     */
    template <typename Container>
    StructTypeImpl(const std::string& name, const Container& members)
    {
        initialize(name);
        add_members(members);
    }
    ...
    StructTypeImpl(const std::string& name, MemberIter begin, MemberIter end)
    {
        initialize(name);
     ...
     *
     */
    StructTypeImpl(const std::string& name, StructTypeImpl&& parent)
    {
        initialize(name, &parent, false);
    }
     ...
     *
     * @param name The name of the type
     * @param members An ininitalizer_list of Members
     */
    StructTypeImpl(
        const std::string& name, std::initializer_list<MemberImpl> members)
    {
        initialize(name);
        add_members(members);
    }
     ...
     *
     * @param name The name of the type
     * @param parent The base type (moved)
     * @param members An ininitalizer_list of Members
     */
    StructTypeImpl(
        const std::string& name,
     ...
     */
    template <typename Container>
    StructTypeImpl& add_members(const Container& members)
    {
        return add_members(members.begin(), members.end());
    }
     ...
     */
    StructTypeImpl& add_members(std::initializer_list<MemberImpl> members)
    {
        return add_members(members.begin(), members.end());
    }
  #endif
     ...
     */
    StructTypeImpl& add_member(MemberImpl&& member)
    {
        return move_member_impl(member);
    }
  #endif
