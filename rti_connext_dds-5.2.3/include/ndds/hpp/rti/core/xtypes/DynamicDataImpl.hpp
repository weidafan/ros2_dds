...
TopicType convert(const DynamicDataImpl& sample)
{
    ...
    TopicType typed_sample;
    dds::topic::topic_type_support<TopicType>::initialize_sample(typed_sample);
    dds::topic::topic_type_support<TopicType>::from_cdr_buffer(
        typed_sample,
...
DynamicDataImpl convert(const TopicType& sample)
{
    ...
    dds::topic::topic_type_support<TopicType>::to_cdr_buffer(tmp_buffer, sample);
