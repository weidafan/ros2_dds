...
protected:
    ...
    Condition(DDS_Condition * native_condition, const Functor& the_handler)
        : native_condition_(native_condition),
          dispatch_func_(NULL)
    {
...
protected:
    ...
    void handler_impl(const Functor& func) // Extension
    {
        ...
        // unique per entity.
        reset_handler_impl();
        dispatch_func_ = new VoidFunctorHolder<Functor>(func);
    }
...
private:
    friend class rti::core::cond::WaitSetImpl;
...
protected:
    ...
    detail::SelfReference<Condition> self_reference_;
