...
public:
    ...
    struct DDS_QosProvider *get() const;
...
public:
     ...
     * the configuration referred to by \p config_name. Specifically, \params 
...
private:
    QosProviderResourceManager native_provider_;
    mutable Semaphore mutex_;
/** @RTI_remove_lines 1 */
};
