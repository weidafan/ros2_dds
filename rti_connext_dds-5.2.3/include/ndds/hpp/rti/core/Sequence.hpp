...
#ifndef RTI_DDS_CORE_SEQUENCE_HPP_
#define RTI_DDS_CORE_SEQUENCE_HPP_
...
public:
    ...
    ContiguousDataSequence(void ** data_buffer, size_t length)
...
#endif /* RTI_DDS_CORE_SEQUENCE_HPP_ */
