...
public:
    ...
    const dds::core::InstanceHandle last_instance_handle() const
    {
        return native().last_instance_handle;
    }
};
...
public:
    ...
    {
        return native().last_subscription_handle;
    }
...
public:
    ...
    const dds::core::InstanceHandle last_publication_handle() const
    {
        return native().last_publication_handle;
    }
...
public:
    ...
    EventCount(IntegerType total, IntegerType change) : Base(total, change)
    {
    }
...
public:
    ...
    /** \dref_DataReaderProtocolStatus_filtered_sample_count
     */
...
public:
    ...
    {
        return native().first_unacknowledged_sample_subscription_handle;
    }
