...
public:
    ...
    ListenerBinder& operator=(dds::core::null_type)
    {
        Base::operator =(dds::core::null);
        return *this;
    }
 ...
 *
 * @brief Creates a ListenerBinder that automatically resets the listener when
 ...
 * @relatesalso ListenerBinder
 *
 * @brief Creates a ListenerBinder that automatically resets the listener and
 * deletes it when all references go out of scope
 *
 * Example:
 *
 * \code
