...
public:
    ...
    TopicImpl(
        ...
        : UntypedTopicDescription(
            detail::create_native_topic<T>(
                participant, name, dds::topic::topic_type_name<T>::value()),
            participant,
            name,
    ...
    TopicImpl(
        ...
        const std::string& type_name)
        : UntypedTopicDescription(
            detail::create_native_topic<T>(participant, name, type_name),
            participant,
            name,
            type_name)
    {
    ...
    TopicImpl(
        ...
        : UntypedTopicDescription(
            detail::create_native_topic<T>(
                participant, name, type_name, &qos, listener, mask),
            participant,
            name,
            type_name)
    {
    ...
    TopicImpl(
        ...
        const dds::core::xtypes::DynamicType& type)
        : UntypedTopicDescription(
            detail::create_native_dynamic_data_topic(participant, name, type),
            participant,
            name,
    ...
    TopicImpl(
        ...
        : UntypedTopicDescription(
            detail::create_native_dynamic_data_topic(
                participant, name, type, &qos, listener, mask),
            participant,
            name,
            rti::core::xtypes::type_name(type))
    {
    ...
    // for internal use
    TopicImpl(DDS_Topic * native_topic)
        : UntypedTopicDescription(
            DDS_Topic_as_entity(native_topic),
            DDS_Topic_as_topicdescription(native_topic))
    {
    }
