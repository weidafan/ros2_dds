...
/*
 * @(#)reda_string.h    generated by: makeheader    Mon Apr 25 07:49:44 2016
 *
...
/*e \ingroup REDAStringClass
  ...
  Static method to print the byte value of the given buffer in hex format.

  @param buffer \b In. Buffer to be printed.
  @param bufferSize \b In. Number of bytes to be printed from buffer.
 */
