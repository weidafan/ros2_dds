...
/*
 * @(#)pres_psGroup_impl.h    generated by: makeheader    Mon Apr 25 07:50:17 2016
 *
...
#define PRESPsReaderGroup_getGuid(__me, __guid, __worker)                     \
    (*(__guid)) = (__me)->_parent.guid

#define PRESPsWriterGroup_getGuid(__me, __guid, __worker)                     \
    (*(__guid)) = (__me)->_parent.guid

/*---------------------------------------------------------------------------*/

#define PRESPsWriterGroup_getStatusChange(me, worker)                 \
    (PRES_STATUS_KIND_MASK_NONE)
