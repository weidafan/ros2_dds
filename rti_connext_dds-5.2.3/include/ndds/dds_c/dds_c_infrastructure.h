...
/*
 * @(#)dds_c_infrastructure.h    generated by: makeheader    Mon Apr 25 07:51:00 2016
 *
...
#define DDS_QOS_POLICY_COUNT 59 /* The count is not including DDS_INVALID_QOS_POLICY_ID */
...
{{16L, -1L, -1L}, /*local_writer_allocation*/      \
 ...
 2048, /* participant property string max length */\
...
#define DDS_ASYNCHRONOUS_PUBLISHER_QOS_POLICY_DEFAULT { \
    ...
    DDS_BOOLEAN_FALSE, DDS_THREAD_SETTINGS_DEFAULT, DDS_SEMAPHORE_BLOCKING_KIND \
}
...
extern DDSCDllExport
void DDS_PropertyQosPolicy_save(const struct DDS_PropertyQosPolicy *self, 
...
typedef struct DDS_WaitSetControlledThreadImpl DDS_WaitSetControlledThread;


DDSC_VARIABLE_LENGTH_VALUE_TYPE_SUPPORT(
        DDS_WaitSetControlledThreadProperty_t);

 
struct DDS_WaitSetControlledThreadProperty_t {
    /*e \dref_WaitSetControlledThreadProperty_wait_set_property */
    struct DDS_WaitSetProperty_t wait_set_property;
    
    /*e \dref_WaitSetControlledThreadProperty_wait_timeout
     */
    struct DDS_Duration_t wait_timeout;
    
    /*e \dref_WaitSetControlledThreadProperty_thread_name
     */
    char * thread_name;
    
    /*e \dref_WaitSetControlledThreadProperty_thread_settings
     */
    struct DDS_ThreadSettings_t thread_settings;        
    
    /*e \dref_WaitSetControlledThreadProperty_thread_safe_access
     */
    DDS_Boolean thread_safe_access;
    
    /*e \dref_WaitSetControlledThread_max_sync_blocking_time
     */
    struct DDS_Duration_t max_sync_blocking_time;
...
/*i \dref_WaitSetControlledThreadProperty_t_INITIALIZER
 */
#define DDS_WaitSetControlledThreadProperty_t_INITIALIZER { \
...
typedef void (*DDS_WaitSetControlledThreadListener_OnThreadSpawnedCallback)(
        void* listener_data,
        DDS_UnsignedLongLong thread_id);


typedef void (*DDS_WaitSetControlledThreadListener_OnThreadDeletedCallback)(
        void* listener_data,
        DDS_UnsignedLongLong thread_id);


typedef void (*DDS_WaitSetControlledThreadListener_OnWaitTimeoutCallback)(
        void* listener_data,
        DDS_UnsignedLongLong thread_id);


struct DDS_WaitSetControlledThreadListener {
    /*ce \dref_WaitSetControlledThreadListener_listener_data
     */
    void * listener_data;

    /*ce \dref_WaitSetControlledThreadListener_on_thread_spawned
     */
    DDS_WaitSetControlledThreadListener_OnThreadSpawnedCallback
            on_background_thread_spawned;

    /*ce \dref_WaitSetControlledThreadListener_on_thread_deleted
     */
    DDS_WaitSetControlledThreadListener_OnThreadDeletedCallback
            on_background_thread_deleted;

    /*ce \dref_WaitSetControlledThreadListener_on_wait_timeout
     */
    DDS_WaitSetControlledThreadListener_OnWaitTimeoutCallback
            on_wait_timeout;

};


#define DDS_WaitSetControlledThreadListener_INITIALIZER {NULL, NULL, NULL, NULL}


typedef void (*DDS_WaitSetControlledThreadEventHandler_OnWakeUpCallback)(
        void* handler_data,
        const struct DDS_ConditionSeq * conditionSeq);


struct DDS_WaitSetControlledThreadEventHandler {
    /*ce \dref_WaitSetControlledThreadEventHandler_handler_data
     */
    void * handler_data;

    /*ce \dref_WaitSetControlledThreadEventHandler_on_wake_up.
     */
    DDS_WaitSetControlledThreadEventHandler_OnWakeUpCallback on_wake_up;
};


#define DDS_WaitSetControlledThreadEventHandler_INITIALIZER {NULL, NULL}

 extern DDSCDllExport
DDS_Boolean DDS_WaitSetControlledThread_is_started(
        DDS_WaitSetControlledThread * self);

 extern DDSCDllExport
DDS_ReturnCode_t DDS_WaitSetControlledThread_attach_condition(
        DDS_WaitSetControlledThread * self,
        DDS_Condition * condition);

 extern DDSCDllExport
DDS_ReturnCode_t DDS_WaitSetControlledThread_detach_condition(
        DDS_WaitSetControlledThread * self,
        DDS_Condition * condition);

 extern DDSCDllExport
DDS_ReturnCode_t DDS_WaitSetControlledThread_start(
        DDS_WaitSetControlledThread * self);

 extern DDSCDllExport
DDS_ReturnCode_t DDS_WaitSetControlledThread_request_stop(
        DDS_WaitSetControlledThread * self);

 extern DDSCDllExport
DDS_ReturnCode_t DDS_WaitSetControlledThread_wait_for_stop(
        DDS_WaitSetControlledThread * self,
        const struct DDS_Duration_t * timeout);

 extern DDSCDllExport
DDS_WaitSetControlledThread * DDS_WaitSetControlledThread_new(
        const struct DDS_WaitSetControlledThreadProperty_t * property,
        struct DDS_WaitSetControlledThreadEventHandler * event_handler,
        struct DDS_WaitSetControlledThreadListener * listener);

 extern DDSCDllExport
void DDS_WaitSetControlledThread_delete(
        DDS_WaitSetControlledThread * self);
