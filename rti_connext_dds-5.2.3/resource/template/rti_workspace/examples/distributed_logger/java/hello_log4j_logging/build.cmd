...
IF NOT EXIST SRC\COM\RTI\HELLO\IDL\HelloWorld.java (
    ECHO Generating type-support code from IDL file
    CD SRC
    CALL "%NDDSHOME_NQ%\bin\rtiddsgen.bat" -package com.rti.hello.idl -language Java -ppDisable -replace HelloWorld.idl
    CD ..
)    
...
FOR /R SRC %%F IN (*.java) DO %JAVAC% -d objs -sourcepath src -classpath "%NDDSHOME_NQ%\lib\java\nddsjava.jar";"%NDDSHOME_NQ%\lib\java\distlog.jar";"%NDDSHOME_NQ%\resource\app\lib\java\log4j-1.2.16.jar" "%%F"
