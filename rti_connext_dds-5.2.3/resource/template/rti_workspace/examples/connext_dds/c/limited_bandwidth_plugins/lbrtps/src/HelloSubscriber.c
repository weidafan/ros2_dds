...
DDS_Boolean start_subscriber(DDS_DomainParticipant *participant,
    ...
    time_t start_time;          /* Time of first iteration w/samples */
    ...
    data_reader = DDS_DomainParticipant_create_datareader_with_profile(
                        participant,
    ...
    printf("Sec.from|Total     |Total Lost|Curr Lost |Average   |Current   |Throughput\n");
    printf("start   |samples   |samples   |samples   |smpls/sec |smpls/sec |Mbps\n");
    printf("--------+----------+----------+----------+----------+----------+----------\n");
    for (;;) {
