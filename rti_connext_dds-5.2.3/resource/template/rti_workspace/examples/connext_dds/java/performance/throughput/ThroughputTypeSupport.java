...
public class ThroughputTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Throughput";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThroughputTypeSupport _singleton
    = new ThroughputTypeSupport();
    ...
    */
    public static ThroughputTypeSupport get_instance() {
        return _singleton;
    }

    public static ThroughputTypeSupport getInstance() {
        return get_instance();
    }
    ...
    * <code>this</code> is not a <code>Throughput</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Throughput typedDst = (Throughput) destination;
        Throughput typedSrc = (Throughput) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, (THROUGHPUT_TEST_PACKET_DATA_SIZE_MAX.VALUE));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Throughput typedSrc = (Throughput) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.BYTE.getSequenceSerializedSize(
            currentAlignment , typedSrc.data );      
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.key);

            dst.writeInt(typedSrc.sequence_number);

            dst.writeByteSeq(typedSrc.data,(THROUGHPUT_TEST_PACKET_DATA_SIZE_MAX.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Throughput typedDst = (Throughput) dst;
            typedDst.clear();      
            try{
                typedDst.key = src.readInt();
                typedDst.sequence_number = src.readInt();
                src.readByteSequence(typedDst.data, (THROUGHPUT_TEST_PACKET_DATA_SIZE_MAX.VALUE));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Throughput typedDst = (Throughput) sample;
    ...
    */
    ...
    int mask) {
        return new ThroughputDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ThroughputDataReader(native_reader, listener, mask, this);   
    ...
    protected ThroughputTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, null ,Throughput.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ThroughputTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, null ,Throughput.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
