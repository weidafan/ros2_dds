...
/**
* A sequence of Throughput instances.
*/
public final class ThroughputSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ThroughputSeq() {
        super(Throughput.class);
    }

    public ThroughputSeq (int initialMaximum) {
        super(Throughput.class, initialMaximum);
    }

    public ThroughputSeq (Collection elements) {
        super(Throughput.class, elements);
    }
