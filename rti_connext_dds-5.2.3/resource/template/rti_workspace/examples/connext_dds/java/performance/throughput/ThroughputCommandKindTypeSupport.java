...
public class ThroughputCommandKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ThroughputCommandKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThroughputCommandKindTypeSupport _singleton
    = new ThroughputCommandKindTypeSupport();
    ...
    */
    public static ThroughputCommandKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ThroughputCommandKindTypeSupport getInstance() {
        return get_instance();
    }
    ...
    public Class get_type() {
        return ThroughputCommandKind.class;
    }
    ...
    * <code>this</code> is not a <code>ThroughputCommandKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ThroughputCommandKind typedSrc = (ThroughputCommandKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ThroughputCommandKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ThroughputCommandKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, null ,ThroughputCommandKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
