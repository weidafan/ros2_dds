...
public class LatencyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Latency";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LatencyTypeSupport _singleton
    = new LatencyTypeSupport();
    ...
    */
    public static LatencyTypeSupport get_instance() {
        return _singleton;
    }

    public static LatencyTypeSupport getInstance() {
        return get_instance();
    }
    ...
    * <code>this</code> is not a <code>Latency</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Latency typedDst = (Latency) destination;
        Latency typedSrc = (Latency) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, (MAX_DATA_SEQUENCE_LENGTH.VALUE));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Latency typedSrc = (Latency) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.data,(MAX_DATA_SEQUENCE_LENGTH.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Latency typedDst = (Latency) dst;
            typedDst.clear();      
            try{
                typedDst.sequence_number = src.readInt();
                src.readByteSequence(typedDst.data, (MAX_DATA_SEQUENCE_LENGTH.VALUE));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Latency typedDst = (Latency) sample;
    ...
    int mask) {
        return new LatencyDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LatencyDataReader(native_reader, listener, mask, this);   
    ...
    protected LatencyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, null ,Latency.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LatencyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, null ,Latency.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
