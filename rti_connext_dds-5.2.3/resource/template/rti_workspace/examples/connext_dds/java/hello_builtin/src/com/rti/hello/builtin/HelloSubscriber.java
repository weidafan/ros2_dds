...
public class HelloSubscriber implements DataReaderListener {
    ...
    private StringSeq _dataSeq = new StringSeq();
    private SampleInfoSeq _infoSeq = new SampleInfoSeq();
    private StringDataReader _reader = null;
    ...
    private void _processData(String instance) {
        ...
        _theSampleId = Integer.parseInt(seqNumberStr);
        ++_theSampleRcvdCount;
    ...
    public void on_data_available(DataReader reader) {
        StringDataReader HelloWorldReader = (StringDataReader)reader;
        ...
        try {
            ...
            for (int i = 0; i < _dataSeq.size(); ++i) {
                ...
                if (info.valid_data) {
                    _processData((String)_dataSeq.get(i));
                }
            }
