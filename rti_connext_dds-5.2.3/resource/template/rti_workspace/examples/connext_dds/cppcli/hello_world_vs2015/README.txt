...
2. Use rtiddsgen to generate the solution/project files for Visual Studio
   ...
   rtiddsgen -language C++/CLI -example i86Win32VS2015 HelloWorld.idl

   You should see the following message, which is normal output:
   rtinddsgenXXX.cc

3. Open the solution file, HelloWorld-dotnet4.6.sln, with Visual Studio 2015. 
...
1. Make sure you have the RTI Data Distribution Service 'lib' directory for 
   i86Win32VS2015 or x64Win64VS2015 in your Path (%NDDSHOME%\lib\<architectrue>).
