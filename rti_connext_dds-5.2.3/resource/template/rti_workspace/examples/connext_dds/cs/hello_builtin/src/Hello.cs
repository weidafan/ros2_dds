...
namespace Hello {
    ...
    public class CommandLineArguments {
        ...
        public const int MIN_PAYLOAD = 10;
        ...
        public const String DEFAULT_TOPIC_NAME = "Hello Builtin";
    ...
    public class Hello {
        ...
        /* usage                                                                       */
        /*                                                                             */
        /* Prints help on command line arguments                                       */
        /*******************************************************************************/
            ...
            for (int i = 1; i < argv.Length; ++i) {
                ...
                if (argv[i].Equals("-s") || argv[i].Equals("--size")) {
                    ...
                    if (args.dataSize < CommandLineArguments.MIN_PAYLOAD) {
                        usage();
                        Console.Error.WriteLine("! Value too small for --size argument: " +
                                    args.dataSize);
                        Console.Error.WriteLine("! For this example, the size of the string cannot be smaller than " +
                                    CommandLineArguments.MIN_PAYLOAD);
                        return;
                    }
                    continue;
                }
