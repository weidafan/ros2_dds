...
namespace Hello {
    ...
    class HelloSubscriber : DDS.DataReaderListener {
        ...
        private DDS.StringSeq _dataSeq = new DDS.StringSeq();
        private DDS.SampleInfoSeq _infoSeq = new DDS.SampleInfoSeq();
        private DDS.StringDataReader _reader = null;
         ...
         */
        private void _processData(String instance) {
             ...
             */
            String seqNumberStr = instance.Substring(0, 9).Trim();
            _theSampleId = Int32.Parse(seqNumberStr);
            ++_theSampleRcvdCount;
            if (_thePayloadSize == 0) {
                _thePayloadSize = instance.Length;
            }
        }
        ...
        public override void on_data_available(DDS.DataReader reader) {
            DDS.StringDataReader HelloWorldReader = (DDS.StringDataReader)reader;
            ...
            try {
                ...
                for (int i = 0; i < _dataSeq.length; ++i) {
                    ...
                    if (info.valid_data) {
                        _processData((String)_dataSeq.get_at(i));
                    }
                }
