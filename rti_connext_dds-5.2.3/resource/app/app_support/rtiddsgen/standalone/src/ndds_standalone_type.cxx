...
10h,10dec05,fcs Fixed compiler warnings
...
#define T DDS_Char*
#define T_initialize_simple    DDS_StringSeq_initialize_string
#define T_finalize_simple      DDS_StringSeq_finalize_string  
#define T_copy                 DDS_StringSeq_copy_string
#include "dds_c_sequence_TSeq.gen"
#undef T_copy
#undef T_finalize_simple
#undef T_initialize_simple
#undef T
#undef TSeq

#define TSeq DDS_WstringSeq
#define T DDS_Wchar*
#define T_initialize_simple DDS_WstringSeq_initialize_string
#define T_finalize_simple   DDS_WstringSeq_finalize_string
