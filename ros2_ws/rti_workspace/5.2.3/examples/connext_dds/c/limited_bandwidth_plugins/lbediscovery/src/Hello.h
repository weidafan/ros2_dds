...
#define QOS_LIBRARY				"LBEDiscoveryPluginExample_Library"
#define PUBLISHER_PROFILE		"LBEDiscoveryPluginExamplePublisher_Profile"
#define SUBSCRIBER_PROFILE		"LBEDiscoveryPluginExampleSubscriber_Profile"
