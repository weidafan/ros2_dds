...
order to locate peers and establish communication.  Before compiling the 
example code, decide where the WAN server will be running and edit the 
WAN_SERVER defined at the top of the publisher and subscriber source files.
...
matching your architecture. For instance, assuming you have installed RTI's
