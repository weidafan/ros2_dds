...
different command shells, either on the same machine or on different machines:
  ...
  > bin/<architecture>/hello-helloworld_subscriber
  > bin/<architecture>/hello-helloworld_publisher

More more information, please consult your "Getting Started Guide."
