...
IF NOT EXIST SRC\COM\RTI\EXAMPLE\PRIMES\IDL\PrimeNumberReply.java (
    ...
    CD SRC
    CALL "%NDDSHOME_NQ%\bin\rtiddsgen.bat" -package com.rti.example.primes.idl -language Java -ppDisable -replace Primes.idl
    CD ..
) 
