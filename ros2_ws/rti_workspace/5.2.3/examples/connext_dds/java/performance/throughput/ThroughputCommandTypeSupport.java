...
public class ThroughputCommandTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ThroughputCommand";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThroughputCommandTypeSupport _singleton
    = new ThroughputCommandTypeSupport();
    ...
    */
    public static ThroughputCommandTypeSupport get_instance() {
        return _singleton;
    }

    public static ThroughputCommandTypeSupport getInstance() {
        return get_instance();
    }
    ...
    public Object create_data() {
        return ThroughputCommand.create();
    }
    ...
    public Class get_type() {
        return ThroughputCommand.class;
    }
    ...
    * <code>this</code> is not a <code>ThroughputCommand</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ThroughputCommand typedDst = (ThroughputCommand) destination;
        ThroughputCommand typedSrc = (ThroughputCommand) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getArrayMaxSizeSerialized(currentAlignment,  (4));
        currentAlignment += ThroughputCommandKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getArrayMaxSizeSerialized(currentAlignment,  (4));
        currentAlignment += ThroughputCommandKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ThroughputCommand typedSrc = (ThroughputCommand) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BYTE.getArrayMaxSizeSerialized(currentAlignment,  (4));
        currentAlignment += ThroughputCommandKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.command);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 4; ++i1__){
                ...
                dst.writeByte(typedSrc.signature[i1__]);
            }

            ThroughputCommandKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.command, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.data_length);

            dst.writeInt(typedSrc.current_publisher_effort);

            dst.writeInt(typedSrc.final_publisher_effort);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ThroughputCommand typedDst = (ThroughputCommand) dst;
            typedDst.clear();      
            try{
                for(int i1__ = 0; i1__< 4; ++i1__){

                    typedDst.signature[i1__] = src.readByte();
                }

                typedDst.command = (ThroughputCommandKind)ThroughputCommandKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.command, src, false, true, endpoint_plugin_qos);     
                typedDst.data_length = src.readInt();
                typedDst.current_publisher_effort = src.readInt();
                typedDst.final_publisher_effort = src.readInt();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ThroughputCommandKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ThroughputCommand typedDst = (ThroughputCommand) sample;
    ...
    int mask) {
        return new ThroughputCommandDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ThroughputCommandDataReader(native_reader, listener, mask, this);   
    ...
    protected ThroughputCommandTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, null ,ThroughputCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ThroughputCommandTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, null ,ThroughputCommand.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
