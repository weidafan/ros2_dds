...
/**
* A sequence of Latency instances.
*/
public final class LatencySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LatencySeq (int initialMaximum) {
        super(Latency.class, initialMaximum);
    }

    public LatencySeq (Collection elements) {
        super(Latency.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, Latency.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' Latency objects (beyond the original size of this object)
