...
public:    
     ...
     */
    void processData(const char * const instance) {
        char idChar[11];
...
public:
    ...
    void on_data_available(DDSDataReader* reader) {
         ...
         */
        DDSStringDataReader *helloReader = DDSStringDataReader::narrow(reader);
        if (helloReader == NULL) {
