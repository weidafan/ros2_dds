...
2. Use rtiddsgen to generate the solution/project files for Visual Studio
   ...
   rtiddsgen -language C++/CLI -example i86Win32VS2013 HelloWorld.idl

   You should see the following message, which is normal output:
   rtinddsgenXXX.cc

3. Open the solution file, HelloWorld-dotnet4.5.1.sln, with Visual Studio 2013.
...
1. Make sure you have the RTI Data Distribution Service 'lib' directory for 
   i86Win32VS2013 in your Path (%NDDSHOME%\lib\i86Win32VS2013 or %NDDSHOME%\lib\x64Win64VS013).
