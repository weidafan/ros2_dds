...
2. Use rtiddsgen to generate the solution/project files for Visual Studio
   ...
   rtiddsgen -language C++/CLI -example i86Win32VS2008 HelloWorld.idl

   You should see the following message, which is normal output:
   rtinddsgenXXX.cc

3. Open the solution file, HelloWorld-dotnet2.0.sln, with Visual Studio 
   (.NET) 2005. 
...
1. Make sure you have the RTI Connext (formerly, RTI Data Distribution Service) 
   'lib' directory for i86Win32VS2008 in your Path (%NDDSHOME%\lib\i86Win32VS2008).
