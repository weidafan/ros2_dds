...
# Run example
$JAVA -Djava.util.logging.config.file=logging.properties -classpath objs:"$NDDSHOME"/lib/java/nddsjava.jar:"$NDDSHOME"/lib/java/distlog.jar com.rti.hello.Hello "$@"
