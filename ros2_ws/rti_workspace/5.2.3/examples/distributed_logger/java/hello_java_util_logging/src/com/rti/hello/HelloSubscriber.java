...
public class HelloSubscriber implements DataReaderListener {
    ...
    private static final Logger logger = Logger.getLogger(
            HelloSubscriber.class.toString());
    ...
    public void on_sample_lost(DataReader reader, 
        ...
        ++_theSampleLost;
        if (_theVerbose > 0) {
            logger.warning("->Callback: sample lost.");            
        }
    }
    ...
    public void on_requested_deadline_missed (DataReader reader, 
        ...
        if (_theVerbose > 0) {
            logger.warning("->Callback: requested deadline missed.");            
        }
    }
    ...
    public void on_requested_incompatible_qos (DataReader reader, 
        ...
        if (_theVerbose > 0) {
            logger.warning("->Callback: requested incompatible QoS.");            
        }
    }
    ...
    public void on_sample_rejected (DataReader reader, 
        ...
        if (_theVerbose > 0) {
            logger.warning("->Callback: sample rejected.");            
        }
    }
    ...
    public void on_liveliness_changed (DataReader reader, 
        ...
        if (_theVerbose > 0) {
            logger.warning("->Callback: liveliness changed.");            
        }
    }
