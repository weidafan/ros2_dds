...
public class HelloPublisher {
    ...
    public HelloPublisher(DomainParticipant participant,
        ...
        if (publisher == null) {
            logger.severe("! Unable to create DDS Publisher");
        ...
        if (_theDataWriter == null) {
            logger.severe("! Unable to create DDS data writer\n");
            return;
        }
    }
    ...
    void writeSamples() {
        ...
        for (instance.sample_id = 0;; ++(instance.sample_id) ) {
            ...
            try {
                ...
                logger.severe("! Write error " + 
                        e.getClass().toString() + ": " + e.getMessage());
                if (++consecutiveErrors > MAX_CONSECUTIVE_WRITE_ERROR) {
                    logger.severe("! Reached maximum number of failure, " +
                        "stopping writer...");
                    return;
                }
            }
