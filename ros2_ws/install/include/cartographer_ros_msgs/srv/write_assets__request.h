...
#ifndef CARTOGRAPHER_ROS_MSGS__SRV__WRITE_ASSETS__REQUEST_H_
#define CARTOGRAPHER_ROS_MSGS__SRV__WRITE_ASSETS__REQUEST_H_
...
#endif  // CARTOGRAPHER_ROS_MSGS__SRV__WRITE_ASSETS__REQUEST_H_
