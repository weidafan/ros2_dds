...
class OptimizationProblemOptions : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_acceleration_weight() const;
  inline void clear_acceleration_weight();
  static const int kAccelerationWeightFieldNumber = 8;
  inline double acceleration_weight() const;
  inline void set_acceleration_weight(double value);
 ...
 private:
  ...
  inline void set_has_acceleration_weight();
  inline void clear_has_acceleration_weight();
