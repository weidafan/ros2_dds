...
#ifndef TEST_COMMUNICATION__SRV__PRIMITIVES__RESPONSE__STRUCT_HPP_
#define TEST_COMMUNICATION__SRV__PRIMITIVES__RESPONSE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_test_communication_srv_Primitives_Response __attribute__((deprecated))
#else
# define DEPRECATED_test_communication_srv_Primitives_Response __declspec(deprecated)
#endif
...
// *INDENT-ON*
  ...
  // pointer types
  using RawPtr =
      test_communication::srv::Primitives_Response_<ContainerAllocator> *;
  using ConstRawPtr =
      const test_communication::srv::Primitives_Response_<ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
    test_communication::srv::Primitives_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
      std::unique_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
      std::weak_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED_test_communication_srv_Primitives_Response
    std::shared_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_test_communication_srv_Primitives_Response
    std::shared_ptr<test_communication::srv::Primitives_Response_<ContainerAllocator> const>
...
using Primitives_Response =
    test_communication::srv::Primitives_Response_<std::allocator<void>>;
...
#endif  // TEST_COMMUNICATION__SRV__PRIMITIVES__RESPONSE__STRUCT_HPP_
