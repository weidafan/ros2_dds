...
#ifndef TEST_COMMUNICATION__MSG__STATIC_ARRAY_PRIMITIVES_H_
#define TEST_COMMUNICATION__MSG__STATIC_ARRAY_PRIMITIVES_H_
...
#endif  // TEST_COMMUNICATION__MSG__STATIC_ARRAY_PRIMITIVES_H_
