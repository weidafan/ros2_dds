...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2run/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/ros2run/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ros2run/environment/pythonpath.sh"
