...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ceres_solver/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/ceres_solver/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ceres_solver/environment/library_path.sh"
