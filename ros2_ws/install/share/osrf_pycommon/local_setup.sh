...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/osrf_pycommon/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/osrf_pycommon/environment/path.sh:$AMENT_CURRENT_PREFIX/share/osrf_pycommon/environment/pythonpath.sh"
