...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gmock_vendor/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/gmock_vendor/environment/path.sh:$AMENT_CURRENT_PREFIX/share/gmock_vendor/environment/library_path.sh"
