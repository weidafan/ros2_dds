...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ros2pkg/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/ros2pkg/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ros2pkg/environment/pythonpath.sh"
