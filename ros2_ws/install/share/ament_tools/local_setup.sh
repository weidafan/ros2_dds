...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_tools/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/ament_tools/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_tools/environment/pythonpath.sh"
