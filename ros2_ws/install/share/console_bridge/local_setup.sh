...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/console_bridge/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/console_bridge/environment/path.sh:$AMENT_CURRENT_PREFIX/share/console_bridge/environment/library_path.sh"
