...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/launch/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/launch/environment/path.sh:$AMENT_CURRENT_PREFIX/share/launch/environment/pythonpath.sh"
