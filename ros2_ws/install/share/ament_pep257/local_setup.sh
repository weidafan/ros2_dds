...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_pep257/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/ament_pep257/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_pep257/environment/pythonpath.sh"
