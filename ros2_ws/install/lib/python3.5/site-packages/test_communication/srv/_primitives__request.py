...
class Metaclass(type):
    """Metaclass of message 'Primitives_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.Primitives_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_primitives__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg_primitives__request
            cls._TYPE_SUPPORT = module.type_support_msg_primitives__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_primitives__request
...
class Primitives_Request(metaclass=Metaclass):
    """Message class 'Primitives_Request'."""
