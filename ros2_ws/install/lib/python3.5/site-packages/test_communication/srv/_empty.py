...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from test_communication.srv import _empty__request
            if _empty__request.Metaclass._TYPE_SUPPORT is None:
                _empty__request.Metaclass.__import_type_support__()
            from test_communication.srv import _empty__response
...
class Empty(metaclass=Metaclass):
    from test_communication.srv._empty__request import Empty_Request as Request
    from test_communication.srv._empty__response import Empty_Response as Response
