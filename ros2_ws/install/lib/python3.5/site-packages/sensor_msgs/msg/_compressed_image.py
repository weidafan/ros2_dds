...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_compressed_image
            cls._CONVERT_TO_PY = module.convert_to_py_msg_compressed_image
            cls._TYPE_SUPPORT = module.type_support_msg_compressed_image
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_compressed_image
