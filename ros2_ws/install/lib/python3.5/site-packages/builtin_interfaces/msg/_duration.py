...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.Duration')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_duration
            cls._CONVERT_TO_PY = module.convert_to_py_msg_duration
            cls._TYPE_SUPPORT = module.type_support_msg_duration
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_duration
...
class Duration(metaclass=Metaclass):
