...
{
  rcl_interfaces__srv__SetParameters_Request * ros_message = rcl_interfaces__srv__SetParameters_Request__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "rcl_interfaces.srv._set_parameters__request.SetParameters_Request",
...
void rcl_interfaces_set_parameters__request__destroy_ros_message(void * raw_ros_message)
{
  ...
  rcl_interfaces__srv__SetParameters_Request__destroy(ros_message);
}
...
PyObject * rcl_interfaces_set_parameters__request__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("rcl_interfaces.srv._set_parameters__request");
