...
{
  rcl_interfaces__msg__ParameterEventDescriptors * ros_message = rcl_interfaces__msg__ParameterEventDescriptors__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "rcl_interfaces.msg._parameter_event_descriptors.ParameterEventDescriptors",
      full_classname_dest, 73) == 0);

  PyObject * pynew_parameters = PyObject_GetAttrString(_pymsg, "new_parameters");
  PyObject * pynew_parameters_msg_module = PyImport_ImportModule("rcl_interfaces.msg._parameter_descriptor");
  PyObject * pynew_parameters_msg_class = PyObject_GetAttrString(pynew_parameters_msg_module, "ParameterDescriptor");
  ...
  rcl_interfaces__msg__ParameterDescriptor * itemnew_parameters;
  size_t sizenew_parameters = PySequence_Size(pynew_parameters);
  if (!rcl_interfaces__msg__ParameterDescriptor__Array__init(&(ros_message->new_parameters), sizenew_parameters)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create rcl_interfaces__msg__ParameterDescriptor__Array ros_message");
    return NULL;
  }
  rcl_interfaces__msg__ParameterDescriptor * destnew_parameters = ros_message->new_parameters.data;
  size_t idxnew_parameters;
  for (idxnew_parameters = 0; idxnew_parameters < sizenew_parameters; idxnew_parameters++) {
    itemnew_parameters = (rcl_interfaces__msg__ParameterDescriptor *) convert_from_py_new_parameters(
      PySequence_Fast_GET_ITEM(seqnew_parameters, idxnew_parameters));
    if (!itemnew_parameters) {
      return NULL;
    }
    memcpy(&destnew_parameters[idxnew_parameters], itemnew_parameters, sizeof(rcl_interfaces__msg__ParameterDescriptor));
  }
  PyObject * pychanged_parameters = PyObject_GetAttrString(_pymsg, "changed_parameters");
  PyObject * pychanged_parameters_msg_module = PyImport_ImportModule("rcl_interfaces.msg._parameter_descriptor");
  PyObject * pychanged_parameters_msg_class = PyObject_GetAttrString(pychanged_parameters_msg_module, "ParameterDescriptor");
  ...
  rcl_interfaces__msg__ParameterDescriptor * itemchanged_parameters;
  size_t sizechanged_parameters = PySequence_Size(pychanged_parameters);
  if (!rcl_interfaces__msg__ParameterDescriptor__Array__init(&(ros_message->changed_parameters), sizechanged_parameters)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create rcl_interfaces__msg__ParameterDescriptor__Array ros_message");
    return NULL;
  }
  rcl_interfaces__msg__ParameterDescriptor * destchanged_parameters = ros_message->changed_parameters.data;
  ...
  for (idxchanged_parameters = 0; idxchanged_parameters < sizechanged_parameters; idxchanged_parameters++) {
    itemchanged_parameters = (rcl_interfaces__msg__ParameterDescriptor *) convert_from_py_changed_parameters(
      PySequence_Fast_GET_ITEM(seqchanged_parameters, idxchanged_parameters));
    if (!itemchanged_parameters) {
      return NULL;
    }
    memcpy(&destchanged_parameters[idxchanged_parameters], itemchanged_parameters, sizeof(rcl_interfaces__msg__ParameterDescriptor));
  }
  PyObject * pydeleted_parameters = PyObject_GetAttrString(_pymsg, "deleted_parameters");
  PyObject * pydeleted_parameters_msg_module = PyImport_ImportModule("rcl_interfaces.msg._parameter_descriptor");
  PyObject * pydeleted_parameters_msg_class = PyObject_GetAttrString(pydeleted_parameters_msg_module, "ParameterDescriptor");
  ...
  rcl_interfaces__msg__ParameterDescriptor * itemdeleted_parameters;
  size_t sizedeleted_parameters = PySequence_Size(pydeleted_parameters);
  if (!rcl_interfaces__msg__ParameterDescriptor__Array__init(&(ros_message->deleted_parameters), sizedeleted_parameters)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create rcl_interfaces__msg__ParameterDescriptor__Array ros_message");
    return NULL;
  }
  rcl_interfaces__msg__ParameterDescriptor * destdeleted_parameters = ros_message->deleted_parameters.data;
  ...
  for (idxdeleted_parameters = 0; idxdeleted_parameters < sizedeleted_parameters; idxdeleted_parameters++) {
    itemdeleted_parameters = (rcl_interfaces__msg__ParameterDescriptor *) convert_from_py_deleted_parameters(
      PySequence_Fast_GET_ITEM(seqdeleted_parameters, idxdeleted_parameters));
    if (!itemdeleted_parameters) {
      return NULL;
    }
    memcpy(&destdeleted_parameters[idxdeleted_parameters], itemdeleted_parameters, sizeof(rcl_interfaces__msg__ParameterDescriptor));
  }
...
void rcl_interfaces_parameter_event_descriptors__destroy_ros_message(void * raw_ros_message)
{
  ...
  rcl_interfaces__msg__ParameterEventDescriptors__destroy(ros_message);
}
