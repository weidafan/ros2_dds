...
{
  rcl_interfaces__srv__GetParameters_Request__Array * array = (rcl_interfaces__srv__GetParameters_Request__Array *)malloc(sizeof(rcl_interfaces__srv__GetParameters_Request__Array));
  if (!array) {
    return NULL;
  }
  bool success = rcl_interfaces__srv__GetParameters_Request__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    rcl_interfaces__srv__GetParameters_Request__Array__fini(array);
  }
  free(array);
}
