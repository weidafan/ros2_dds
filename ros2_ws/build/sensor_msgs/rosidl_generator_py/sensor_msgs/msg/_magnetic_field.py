...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.MagneticField')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_magnetic_field
            cls._CONVERT_TO_PY = module.convert_to_py_msg_magnetic_field
            cls._TYPE_SUPPORT = module.type_support_msg_magnetic_field
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_magnetic_field
...
class MagneticField(metaclass=Metaclass):
    ...
    def __init__(self, **kwargs):
        ...
        self.magnetic_field_covariance = kwargs.get(
    ...
    def magnetic_field_covariance(self, value):
        ...
        assert \
            ((isinstance(value, Sequence) or
             ...
             True), \
            "The 'magnetic_field_covariance' field must be a set or sequence with length 9 and each value of type 'float'"
