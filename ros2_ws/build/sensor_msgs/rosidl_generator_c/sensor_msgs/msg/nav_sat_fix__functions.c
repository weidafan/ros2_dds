...
sensor_msgs__msg__NavSatFix__init(sensor_msgs__msg__NavSatFix * msg)
{
  ...
  // status
  sensor_msgs__msg__NavSatStatus__init(&msg->status);
  // latitude
  // longitude
  // altitude
  // position_covariance
...
bool
sensor_msgs__msg__NavSatFix__Array__init(sensor_msgs__msg__NavSatFix__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
sensor_msgs__msg__NavSatFix__Array__fini(sensor_msgs__msg__NavSatFix__Array * array)
{
  if (!array) {
    return;
  }
...
sensor_msgs__msg__NavSatFix__Array__create(size_t size)
{
  sensor_msgs__msg__NavSatFix__Array * array = (sensor_msgs__msg__NavSatFix__Array *)malloc(sizeof(sensor_msgs__msg__NavSatFix__Array));
  if (!array) {
    return NULL;
  }
  bool success = sensor_msgs__msg__NavSatFix__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
sensor_msgs__msg__NavSatFix__Array__destroy(sensor_msgs__msg__NavSatFix__Array * array)
{
  if (array) {
    sensor_msgs__msg__NavSatFix__Array__fini(array);
  }
  free(array);
}
