...
sensor_msgs__msg__JoyFeedbackArray__init(sensor_msgs__msg__JoyFeedbackArray * msg)
{
  ...
  // array
  sensor_msgs__msg__JoyFeedback__Array__init(&msg->array, 0);
  return true;
}
...
sensor_msgs__msg__JoyFeedbackArray__fini(sensor_msgs__msg__JoyFeedbackArray * msg)
{
  ...
  // array
  sensor_msgs__msg__JoyFeedback__Array__fini(&msg->array);
}
...
{
  sensor_msgs__msg__JoyFeedbackArray__Array * array = (sensor_msgs__msg__JoyFeedbackArray__Array *)malloc(sizeof(sensor_msgs__msg__JoyFeedbackArray__Array));
  if (!array) {
    return NULL;
  }
  bool success = sensor_msgs__msg__JoyFeedbackArray__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    sensor_msgs__msg__JoyFeedbackArray__Array__fini(array);
  }
  free(array);
}
