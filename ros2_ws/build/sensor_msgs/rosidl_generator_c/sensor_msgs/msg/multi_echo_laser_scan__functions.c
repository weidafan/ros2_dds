...
sensor_msgs__msg__MultiEchoLaserScan__init(sensor_msgs__msg__MultiEchoLaserScan * msg)
{
  ...
  // range_max
  // ranges
  sensor_msgs__msg__LaserEcho__Array__init(&msg->ranges, 0);
  // intensities
  sensor_msgs__msg__LaserEcho__Array__init(&msg->intensities, 0);
  return true;
}
...
sensor_msgs__msg__MultiEchoLaserScan__fini(sensor_msgs__msg__MultiEchoLaserScan * msg)
{
  ...
  // range_max
  // ranges
  sensor_msgs__msg__LaserEcho__Array__fini(&msg->ranges);
  // intensities
  sensor_msgs__msg__LaserEcho__Array__fini(&msg->intensities);
}
...
{
  sensor_msgs__msg__MultiEchoLaserScan__Array * array = (sensor_msgs__msg__MultiEchoLaserScan__Array *)malloc(sizeof(sensor_msgs__msg__MultiEchoLaserScan__Array));
  if (!array) {
    return NULL;
  }
  bool success = sensor_msgs__msg__MultiEchoLaserScan__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    sensor_msgs__msg__MultiEchoLaserScan__Array__fini(array);
  }
  free(array);
}
