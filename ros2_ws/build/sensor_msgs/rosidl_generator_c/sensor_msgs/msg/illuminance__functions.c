...
{
  sensor_msgs__msg__Illuminance__Array * array = (sensor_msgs__msg__Illuminance__Array *)malloc(sizeof(sensor_msgs__msg__Illuminance__Array));
  if (!array) {
    return NULL;
  }
  bool success = sensor_msgs__msg__Illuminance__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    sensor_msgs__msg__Illuminance__Array__fini(array);
  }
  free(array);
}
