...
bool
sensor_msgs__msg__RelativeHumidity__Array__init(sensor_msgs__msg__RelativeHumidity__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
sensor_msgs__msg__RelativeHumidity__Array__fini(sensor_msgs__msg__RelativeHumidity__Array * array)
{
  if (!array) {
    return;
  }
...
sensor_msgs__msg__RelativeHumidity__Array__create(size_t size)
{
  sensor_msgs__msg__RelativeHumidity__Array * array = (sensor_msgs__msg__RelativeHumidity__Array *)malloc(sizeof(sensor_msgs__msg__RelativeHumidity__Array));
  if (!array) {
    return NULL;
  }
  bool success = sensor_msgs__msg__RelativeHumidity__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
sensor_msgs__msg__RelativeHumidity__Array__destroy(sensor_msgs__msg__RelativeHumidity__Array * array)
{
  if (array) {
    sensor_msgs__msg__RelativeHumidity__Array__fini(array);
  }
  free(array);
}
