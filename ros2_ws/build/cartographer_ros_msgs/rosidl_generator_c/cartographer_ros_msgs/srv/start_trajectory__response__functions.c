...
{
  cartographer_ros_msgs__srv__StartTrajectory_Response__Array * array = (cartographer_ros_msgs__srv__StartTrajectory_Response__Array *)malloc(sizeof(cartographer_ros_msgs__srv__StartTrajectory_Response__Array));
  if (!array) {
    return NULL;
  }
  bool success = cartographer_ros_msgs__srv__StartTrajectory_Response__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    cartographer_ros_msgs__srv__StartTrajectory_Response__Array__fini(array);
  }
  free(array);
}
