...
{
  cartographer_ros_msgs__srv__FinishTrajectory_Request__Array * array = (cartographer_ros_msgs__srv__FinishTrajectory_Request__Array *)malloc(sizeof(cartographer_ros_msgs__srv__FinishTrajectory_Request__Array));
  if (!array) {
    return NULL;
  }
  bool success = cartographer_ros_msgs__srv__FinishTrajectory_Request__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    cartographer_ros_msgs__srv__FinishTrajectory_Request__Array__fini(array);
  }
  free(array);
}
