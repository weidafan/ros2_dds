...
{
  lifecycle_msgs__msg__TransitionDescription * ros_message = lifecycle_msgs__msg__TransitionDescription__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "lifecycle_msgs.msg._transition_description.TransitionDescription",
...
{
  lifecycle_msgs__msg__TransitionDescription * ros_message = (lifecycle_msgs__msg__TransitionDescription *)raw_ros_message;
  (void)ros_message;

  lifecycle_msgs__msg__TransitionDescription__destroy(ros_message);
}
...
PyObject * lifecycle_msgs_transition_description__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("lifecycle_msgs.msg._transition_description");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TransitionDescription");

  /* NOTE(esteve): Call constructor of TransitionDescription */
