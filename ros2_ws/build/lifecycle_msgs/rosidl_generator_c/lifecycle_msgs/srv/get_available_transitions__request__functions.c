...
lifecycle_msgs__srv__GetAvailableTransitions_Request__init(lifecycle_msgs__srv__GetAvailableTransitions_Request * msg)
{
  ...
  // node_name
  rosidl_generator_c__String__init(&msg->node_name);
  return true;
}
...
bool
lifecycle_msgs__srv__GetAvailableTransitions_Request__Array__init(lifecycle_msgs__srv__GetAvailableTransitions_Request__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
lifecycle_msgs__srv__GetAvailableTransitions_Request__Array__fini(lifecycle_msgs__srv__GetAvailableTransitions_Request__Array * array)
{
  if (!array) {
    return;
  }
...
lifecycle_msgs__srv__GetAvailableTransitions_Request__Array__create(size_t size)
{
  lifecycle_msgs__srv__GetAvailableTransitions_Request__Array * array = (lifecycle_msgs__srv__GetAvailableTransitions_Request__Array *)malloc(sizeof(lifecycle_msgs__srv__GetAvailableTransitions_Request__Array));
  if (!array) {
    return NULL;
  }
  bool success = lifecycle_msgs__srv__GetAvailableTransitions_Request__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
lifecycle_msgs__srv__GetAvailableTransitions_Request__Array__destroy(lifecycle_msgs__srv__GetAvailableTransitions_Request__Array * array)
{
  if (array) {
    lifecycle_msgs__srv__GetAvailableTransitions_Request__Array__fini(array);
  }
  free(array);
}
