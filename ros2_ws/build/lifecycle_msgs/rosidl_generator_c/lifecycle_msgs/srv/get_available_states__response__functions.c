...
lifecycle_msgs__srv__GetAvailableStates_Response__init(lifecycle_msgs__srv__GetAvailableStates_Response * msg)
{
  ...
  // available_states
  lifecycle_msgs__msg__State__Array__init(&msg->available_states, 0);
  return true;
}
...
lifecycle_msgs__srv__GetAvailableStates_Response__fini(lifecycle_msgs__srv__GetAvailableStates_Response * msg)
{
  ...
  // available_states
  lifecycle_msgs__msg__State__Array__fini(&msg->available_states);
}

lifecycle_msgs__srv__GetAvailableStates_Response *
lifecycle_msgs__srv__GetAvailableStates_Response__create()
{
  lifecycle_msgs__srv__GetAvailableStates_Response * msg = (lifecycle_msgs__srv__GetAvailableStates_Response *)malloc(sizeof(lifecycle_msgs__srv__GetAvailableStates_Response));
  if (!msg) {
    return NULL;
  }
...
lifecycle_msgs__srv__GetAvailableStates_Response__Array__init(lifecycle_msgs__srv__GetAvailableStates_Response__Array * array, size_t size)
{
  ...
  if (size) {
    data = (lifecycle_msgs__srv__GetAvailableStates_Response *)calloc(size, sizeof(lifecycle_msgs__srv__GetAvailableStates_Response));
    if (!data) {
      return false;
    }
...
{
  lifecycle_msgs__srv__GetAvailableStates_Response__Array * array = (lifecycle_msgs__srv__GetAvailableStates_Response__Array *)malloc(sizeof(lifecycle_msgs__srv__GetAvailableStates_Response__Array));
  if (!array) {
    return NULL;
  }
  bool success = lifecycle_msgs__srv__GetAvailableStates_Response__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    lifecycle_msgs__srv__GetAvailableStates_Response__Array__fini(array);
  }
  free(array);
}
