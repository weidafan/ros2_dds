...
#include "lifecycle_msgs/srv/get_state__request__functions.h"
...
bool
lifecycle_msgs__srv__GetState_Request__Array__init(lifecycle_msgs__srv__GetState_Request__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
lifecycle_msgs__srv__GetState_Request__Array__fini(lifecycle_msgs__srv__GetState_Request__Array * array)
{
  if (!array) {
    return;
  }
...
lifecycle_msgs__srv__GetState_Request__Array *
lifecycle_msgs__srv__GetState_Request__Array__create(size_t size)
{
  lifecycle_msgs__srv__GetState_Request__Array * array = (lifecycle_msgs__srv__GetState_Request__Array *)malloc(sizeof(lifecycle_msgs__srv__GetState_Request__Array));
  if (!array) {
    return NULL;
  }
  bool success = lifecycle_msgs__srv__GetState_Request__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    lifecycle_msgs__srv__GetState_Request__Array__fini(array);
  }
  free(array);
}
