...
diagnostic_msgs__msg__DiagnosticArray__init(diagnostic_msgs__msg__DiagnosticArray * msg)
{
  ...
  // status
  diagnostic_msgs__msg__DiagnosticStatus__Array__init(&msg->status, 0);
  return true;
}
...
{
  diagnostic_msgs__msg__DiagnosticArray__Array * array = (diagnostic_msgs__msg__DiagnosticArray__Array *)malloc(sizeof(diagnostic_msgs__msg__DiagnosticArray__Array));
  if (!array) {
    return NULL;
  }
  bool success = diagnostic_msgs__msg__DiagnosticArray__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    diagnostic_msgs__msg__DiagnosticArray__Array__fini(array);
  }
  free(array);
}
