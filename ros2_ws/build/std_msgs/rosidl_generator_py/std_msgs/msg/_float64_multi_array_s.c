...
{
  std_msgs__msg__Float64MultiArray * ros_message = std_msgs__msg__Float64MultiArray__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "std_msgs.msg._float64_multi_array.Float64MultiArray",
...
PyObject * std_msgs_float64_multi_array__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._float64_multi_array");
  ...
  double * tmpmessagedatadata = ros_message->data.data;
