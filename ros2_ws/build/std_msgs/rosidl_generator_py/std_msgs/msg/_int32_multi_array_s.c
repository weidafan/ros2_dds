...
{
  std_msgs__msg__Int32MultiArray * ros_message = std_msgs__msg__Int32MultiArray__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "std_msgs.msg._int32_multi_array.Int32MultiArray",
...
PyObject * std_msgs_int32_multi_array__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._int32_multi_array");
  ...
  int32_t * tmpmessagedatadata = ros_message->data.data;
