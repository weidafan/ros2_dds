...
{
  std_msgs__msg__UInt8MultiArray * ros_message = std_msgs__msg__UInt8MultiArray__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "std_msgs.msg._u_int8_multi_array.UInt8MultiArray",
...
PyObject * std_msgs_u_int8_multi_array__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._u_int8_multi_array");
