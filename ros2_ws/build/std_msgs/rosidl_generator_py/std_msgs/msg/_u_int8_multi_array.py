...
class Metaclass(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.UInt8MultiArray')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_u_int8_multi_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg_u_int8_multi_array
            cls._TYPE_SUPPORT = module.type_support_msg_u_int8_multi_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_u_int8_multi_array
...
class UInt8MultiArray(metaclass=Metaclass):
