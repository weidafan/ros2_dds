...
{
  std_msgs__msg__UInt32 * ros_message = std_msgs__msg__UInt32__create();
  (void)ros_message;
...
{
  std_msgs__msg__UInt32 * ros_message = (std_msgs__msg__UInt32 *)raw_ros_message;
  (void)ros_message;

  std_msgs__msg__UInt32__destroy(ros_message);
}
...
PyObject * std_msgs_u_int32__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("std_msgs.msg._u_int32");
