...
std_msgs__msg__UInt64MultiArray__init(std_msgs__msg__UInt64MultiArray * msg)
{
  ...
  // data
  rosidl_generator_c__uint64__Array__init(&msg->data, 0);
  return true;
}
...
std_msgs__msg__UInt64MultiArray__fini(std_msgs__msg__UInt64MultiArray * msg)
{
  ...
  // data
  rosidl_generator_c__uint64__Array__fini(&msg->data);
}
...
{
  std_msgs__msg__UInt64MultiArray__Array * array = (std_msgs__msg__UInt64MultiArray__Array *)malloc(sizeof(std_msgs__msg__UInt64MultiArray__Array));
  if (!array) {
    return NULL;
  }
  bool success = std_msgs__msg__UInt64MultiArray__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    std_msgs__msg__UInt64MultiArray__Array__fini(array);
  }
  free(array);
}
