...
std_msgs__msg__String__init(std_msgs__msg__String * msg)
{
  ...
  // data
  rosidl_generator_c__String__init(&msg->data);
  return true;
}
...
{
  std_msgs__msg__String__Array * array = (std_msgs__msg__String__Array *)malloc(sizeof(std_msgs__msg__String__Array));
  if (!array) {
    return NULL;
  }
  bool success = std_msgs__msg__String__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    std_msgs__msg__String__Array__fini(array);
  }
  free(array);
}
