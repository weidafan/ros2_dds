...
std_msgs__msg__UInt8MultiArray__init(std_msgs__msg__UInt8MultiArray * msg)
{
  ...
  // data
  rosidl_generator_c__uint8__Array__init(&msg->data, 0);
  return true;
}
...
{
  std_msgs__msg__UInt8MultiArray__Array * array = (std_msgs__msg__UInt8MultiArray__Array *)malloc(sizeof(std_msgs__msg__UInt8MultiArray__Array));
  if (!array) {
    return NULL;
  }
  bool success = std_msgs__msg__UInt8MultiArray__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    std_msgs__msg__UInt8MultiArray__Array__fini(array);
  }
  free(array);
}
