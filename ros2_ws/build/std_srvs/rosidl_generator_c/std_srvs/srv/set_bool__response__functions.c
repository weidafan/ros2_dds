...
std_srvs__srv__SetBool_Response__init(std_srvs__srv__SetBool_Response * msg)
{
  ...
  // success
  // message
  rosidl_generator_c__String__init(&msg->message);
  return true;
}
...
bool
std_srvs__srv__SetBool_Response__Array__init(std_srvs__srv__SetBool_Response__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
std_srvs__srv__SetBool_Response__Array__fini(std_srvs__srv__SetBool_Response__Array * array)
{
  if (!array) {
    return;
  }
...
std_srvs__srv__SetBool_Response__Array *
std_srvs__srv__SetBool_Response__Array__create(size_t size)
{
  std_srvs__srv__SetBool_Response__Array * array = (std_srvs__srv__SetBool_Response__Array *)malloc(sizeof(std_srvs__srv__SetBool_Response__Array));
  if (!array) {
    return NULL;
  }
  bool success = std_srvs__srv__SetBool_Response__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
std_srvs__srv__SetBool_Response__Array__destroy(std_srvs__srv__SetBool_Response__Array * array)
{
  if (array) {
    std_srvs__srv__SetBool_Response__Array__fini(array);
  }
  free(array);
}
