...
{
  std_srvs__srv__Trigger_Response * ros_message = std_srvs__srv__Trigger_Response__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "std_srvs.srv._trigger__response.Trigger_Response",
...
PyObject * std_srvs_trigger__response__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("std_srvs.srv._trigger__response");
