...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Empty_service_members = {
  ...
  // see get_service_type_support_handle<std_srvs::Empty>()
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, std_srvs, Empty)() {
