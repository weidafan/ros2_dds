...
static rosidl_typesupport_introspection_c__MessageMember example_interfaces__srv__rosidl_typesupport_introspection_c__AddTwoInts_Response_message_member_array[1] = {
  {
    "sum",  // name
