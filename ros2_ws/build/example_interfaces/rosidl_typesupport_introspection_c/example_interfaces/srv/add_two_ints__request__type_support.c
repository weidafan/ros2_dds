...
static rosidl_typesupport_introspection_c__MessageMember example_interfaces__srv__rosidl_typesupport_introspection_c__AddTwoInts_Request_message_member_array[2] = {
  {
    "a",  // name
