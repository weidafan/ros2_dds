...
{
  geometry_msgs__msg__Twist__Array * array = (geometry_msgs__msg__Twist__Array *)malloc(sizeof(geometry_msgs__msg__Twist__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__Twist__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    geometry_msgs__msg__Twist__Array__fini(array);
  }
  free(array);
}
