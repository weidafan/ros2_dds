...
geometry_msgs__msg__AccelWithCovarianceStamped__init(geometry_msgs__msg__AccelWithCovarianceStamped * msg)
{
  ...
  // accel
  geometry_msgs__msg__AccelWithCovariance__init(&msg->accel);
  return true;
}
...
bool
geometry_msgs__msg__AccelWithCovarianceStamped__Array__init(geometry_msgs__msg__AccelWithCovarianceStamped__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
geometry_msgs__msg__AccelWithCovarianceStamped__Array__fini(geometry_msgs__msg__AccelWithCovarianceStamped__Array * array)
{
  if (!array) {
    return;
  }
...
geometry_msgs__msg__AccelWithCovarianceStamped__Array__create(size_t size)
{
  geometry_msgs__msg__AccelWithCovarianceStamped__Array * array = (geometry_msgs__msg__AccelWithCovarianceStamped__Array *)malloc(sizeof(geometry_msgs__msg__AccelWithCovarianceStamped__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__AccelWithCovarianceStamped__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
geometry_msgs__msg__AccelWithCovarianceStamped__Array__destroy(geometry_msgs__msg__AccelWithCovarianceStamped__Array * array)
{
  if (array) {
    geometry_msgs__msg__AccelWithCovarianceStamped__Array__fini(array);
  }
  free(array);
}
