...
{
  geometry_msgs__msg__PolygonStamped__Array * array = (geometry_msgs__msg__PolygonStamped__Array *)malloc(sizeof(geometry_msgs__msg__PolygonStamped__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__PolygonStamped__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    geometry_msgs__msg__PolygonStamped__Array__fini(array);
  }
  free(array);
}
