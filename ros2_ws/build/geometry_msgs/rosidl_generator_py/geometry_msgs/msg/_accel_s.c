...
{
  geometry_msgs__msg__Accel * ros_message = geometry_msgs__msg__Accel__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "geometry_msgs.msg._accel.Accel",
...
{
  geometry_msgs__msg__Accel * ros_message = (geometry_msgs__msg__Accel *)raw_ros_message;
  (void)ros_message;

  geometry_msgs__msg__Accel__destroy(ros_message);
}
...
PyObject * geometry_msgs_accel__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("geometry_msgs.msg._accel");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Accel");

  /* NOTE(esteve): Call constructor of Accel */
