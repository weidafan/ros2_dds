...
{
  geometry_msgs__msg__TwistWithCovarianceStamped * ros_message = geometry_msgs__msg__TwistWithCovarianceStamped__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "geometry_msgs.msg._twist_with_covariance_stamped.TwistWithCovarianceStamped",
...
{
  geometry_msgs__msg__TwistWithCovarianceStamped * ros_message = (geometry_msgs__msg__TwistWithCovarianceStamped *)raw_ros_message;
  (void)ros_message;

  geometry_msgs__msg__TwistWithCovarianceStamped__destroy(ros_message);
}
...
PyObject * geometry_msgs_twist_with_covariance_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("geometry_msgs.msg._twist_with_covariance_stamped");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TwistWithCovarianceStamped");

  /* NOTE(esteve): Call constructor of TwistWithCovarianceStamped */
