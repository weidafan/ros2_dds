...
{
  geometry_msgs__msg__PoseStamped * ros_message = geometry_msgs__msg__PoseStamped__create();
  (void)ros_message;
...
{
  geometry_msgs__msg__PoseStamped * ros_message = (geometry_msgs__msg__PoseStamped *)raw_ros_message;
  (void)ros_message;

  geometry_msgs__msg__PoseStamped__destroy(ros_message);
}
...
PyObject * geometry_msgs_pose_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("geometry_msgs.msg._pose_stamped");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseStamped");

  /* NOTE(esteve): Call constructor of PoseStamped */
