...
{
  geometry_msgs__msg__AccelStamped * ros_message = geometry_msgs__msg__AccelStamped__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "geometry_msgs.msg._accel_stamped.AccelStamped",
...
{
  geometry_msgs__msg__AccelStamped * ros_message = (geometry_msgs__msg__AccelStamped *)raw_ros_message;
  (void)ros_message;

  geometry_msgs__msg__AccelStamped__destroy(ros_message);
}
...
PyObject * geometry_msgs_accel_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("geometry_msgs.msg._accel_stamped");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AccelStamped");

  /* NOTE(esteve): Call constructor of AccelStamped */
