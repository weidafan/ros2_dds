...
#ifndef TEST_COMMUNICATION__MSG__FIELDS_WITH_SAME_TYPE__TYPE_SUPPORT_H_
#define TEST_COMMUNICATION__MSG__FIELDS_WITH_SAME_TYPE__TYPE_SUPPORT_H_
...
#endif  // TEST_COMMUNICATION__MSG__FIELDS_WITH_SAME_TYPE__TYPE_SUPPORT_H_
