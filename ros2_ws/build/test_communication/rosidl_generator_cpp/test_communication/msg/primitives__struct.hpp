...
#ifndef TEST_COMMUNICATION__MSG__PRIMITIVES__STRUCT_HPP_
#define TEST_COMMUNICATION__MSG__PRIMITIVES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_test_communication_msg_Primitives __attribute__((deprecated))
#else
# define DEPRECATED_test_communication_msg_Primitives __declspec(deprecated)
#endif
...
struct Primitives_
{
  using Type = Primitives_<ContainerAllocator>;

  Primitives_()
  {
  }
  explicit Primitives_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  using ConstRawPtr =
      const test_communication::msg::Primitives_<ContainerAllocator> *;
  using SharedPtr =
      std::shared_ptr<test_communication::msg::Primitives_<ContainerAllocator>>;
  using ConstSharedPtr =
      std::shared_ptr<test_communication::msg::Primitives_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
    test_communication::msg::Primitives_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
      std::unique_ptr<test_communication::msg::Primitives_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
      std::unique_ptr<test_communication::msg::Primitives_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
      std::weak_ptr<test_communication::msg::Primitives_<ContainerAllocator>>;
  using ConstWeakPtr =
      std::weak_ptr<test_communication::msg::Primitives_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED_test_communication_msg_Primitives
    std::shared_ptr<test_communication::msg::Primitives_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_test_communication_msg_Primitives
    std::shared_ptr<test_communication::msg::Primitives_<ContainerAllocator> const>
  ...
  bool operator==(const Primitives_ & other) const
  {
...
using Primitives =
    test_communication::msg::Primitives_<std::allocator<void>>;
...
#endif  // TEST_COMMUNICATION__MSG__PRIMITIVES__STRUCT_HPP_
