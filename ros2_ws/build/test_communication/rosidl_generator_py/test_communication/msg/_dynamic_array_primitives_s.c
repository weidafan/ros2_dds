...
{
  test_communication__msg__DynamicArrayPrimitives * ros_message = test_communication__msg__DynamicArrayPrimitives__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "test_communication.msg._dynamic_array_primitives.DynamicArrayPrimitives",
...
{
  test_communication__msg__DynamicArrayPrimitives * ros_message = (test_communication__msg__DynamicArrayPrimitives *)raw_ros_message;
  (void)ros_message;

  test_communication__msg__DynamicArrayPrimitives__destroy(ros_message);
}
...
PyObject * test_communication_dynamic_array_primitives__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("test_communication.msg._dynamic_array_primitives");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamicArrayPrimitives");

  /* NOTE(esteve): Call constructor of DynamicArrayPrimitives */
