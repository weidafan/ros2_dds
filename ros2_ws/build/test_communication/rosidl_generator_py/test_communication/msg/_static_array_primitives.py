...
class Metaclass(type):
    """Metaclass of message 'StaticArrayPrimitives'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.StaticArrayPrimitives')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_static_array_primitives
            cls._CONVERT_TO_PY = module.convert_to_py_msg_static_array_primitives
            cls._TYPE_SUPPORT = module.type_support_msg_static_array_primitives
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_static_array_primitives
...
class StaticArrayPrimitives(metaclass=Metaclass):
    """Message class 'StaticArrayPrimitives'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.bool_values = kwargs.get(
            'bool_values',
            list([bool() for x in range(3)])
        )
        self.byte_values = kwargs.get(
            'byte_values',
            list([bytes([0]) for x in range(3)])
        )
        self.char_values = kwargs.get(
            'char_values',
            list([chr(0) for x in range(3)])
        )
        self.float32_values = kwargs.get(
            'float32_values',
            list([float() for x in range(3)])
        )
        self.float64_values = kwargs.get(
            'float64_values',
            list([float() for x in range(3)])
        )
        self.int8_values = kwargs.get(
            'int8_values',
            list([int() for x in range(3)])
        )
        self.uint8_values = kwargs.get(
            'uint8_values',
            list([int() for x in range(3)])
        )
        self.int16_values = kwargs.get(
            'int16_values',
            list([int() for x in range(3)])
        )
        self.uint16_values = kwargs.get(
            'uint16_values',
            list([int() for x in range(3)])
        )
        self.int32_values = kwargs.get(
            'int32_values',
            list([int() for x in range(3)])
        )
        self.uint32_values = kwargs.get(
            'uint32_values',
            list([int() for x in range(3)])
        )
        self.int64_values = kwargs.get(
            'int64_values',
            list([int() for x in range(3)])
        )
        self.uint64_values = kwargs.get(
            'uint64_values',
            list([int() for x in range(3)])
        )
        self.string_values = kwargs.get(
            'string_values',
            list([str() for x in range(3)])
        )
    ...
    def char_values(self, value):
        ...
        assert \
            ...
            "The 'char_values' field must be a set or sequence with length 3 and each value of type 'str' and each characters ord() in [-128, 128)"
    ...
    def float32_values(self, value):
        ...
        assert \
            ((isinstance(value, Sequence) or
             ...
             True), \
            "The 'float32_values' field must be a set or sequence with length 3 and each value of type 'float'"
    ...
    def float64_values(self, value):
        ...
        assert \
            ((isinstance(value, Sequence) or
             ...
             all([isinstance(v, float) for v in value]) and
             True), \
            "The 'float64_values' field must be a set or sequence with length 3 and each value of type 'float'"
    ...
    def int8_values(self, value):
        ...
        assert \
            ...
            "The 'int8_values' field must be a set or sequence with length 3 and each value of type 'int' and each integer in [-128, 128)"
    ...
    def uint8_values(self, value):
        ...
        assert \
            ...
            "The 'uint8_values' field must be a set or sequence with length 3 and each value of type 'int' and each unsigned integer in [0, 256)"
    ...
    def int16_values(self, value):
        ...
        assert \
            ...
            "The 'int16_values' field must be a set or sequence with length 3 and each value of type 'int' and each integer in [-32768, 32768)"
    ...
    def uint16_values(self, value):
        ...
        assert \
            ...
            "The 'uint16_values' field must be a set or sequence with length 3 and each value of type 'int' and each unsigned integer in [0, 65536)"
    ...
    def int32_values(self, value):
        ...
        assert \
            ...
            "The 'int32_values' field must be a set or sequence with length 3 and each value of type 'int' and each integer in [-2147483648, 2147483648)"
    ...
    def uint32_values(self, value):
        ...
        assert \
            ...
            "The 'uint32_values' field must be a set or sequence with length 3 and each value of type 'int' and each unsigned integer in [0, 4294967296)"
    ...
    def int64_values(self, value):
        ...
        assert \
            ...
            "The 'int64_values' field must be a set or sequence with length 3 and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775808)"
    ...
    def uint64_values(self, value):
        ...
        assert \
            ...
            "The 'uint64_values' field must be a set or sequence with length 3 and each value of type 'int' and each unsigned integer in [0, 18446744073709551616)"
