...
{
  test_communication__msg__Primitives * ros_message = test_communication__msg__Primitives__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "test_communication.msg._primitives.Primitives",
...
{
  test_communication__msg__Primitives * ros_message = (test_communication__msg__Primitives *)raw_ros_message;
  (void)ros_message;

  test_communication__msg__Primitives__destroy(ros_message);
}
...
PyObject * test_communication_primitives__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("test_communication.msg._primitives");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Primitives");

  /* NOTE(esteve): Call constructor of Primitives */
