...
{
  test_communication__msg__DynamicArrayNested * ros_message = test_communication__msg__DynamicArrayNested__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "test_communication.msg._dynamic_array_nested.DynamicArrayNested",
...
{
  test_communication__msg__DynamicArrayNested * ros_message = (test_communication__msg__DynamicArrayNested *)raw_ros_message;
  (void)ros_message;

  test_communication__msg__DynamicArrayNested__destroy(ros_message);
}
...
PyObject * test_communication_dynamic_array_nested__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("test_communication.msg._dynamic_array_nested");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DynamicArrayNested");

  /* NOTE(esteve): Call constructor of DynamicArrayNested */
