...
class Metaclass(type):
    """Metaclass of message 'BoundedArrayPrimitives'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger('rosidl_generator_py.BoundedArrayPrimitives')
            logger.debug(
                'Failed to import needed modules for type support:\n' + traceback.format_exc())
        else:
            cls._CONVERT_FROM_PY = module.convert_from_py_msg_bounded_array_primitives
            cls._CONVERT_TO_PY = module.convert_to_py_msg_bounded_array_primitives
            cls._TYPE_SUPPORT = module.type_support_msg_bounded_array_primitives
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg_bounded_array_primitives
...
class BoundedArrayPrimitives(metaclass=Metaclass):
    """Message class 'BoundedArrayPrimitives'."""
