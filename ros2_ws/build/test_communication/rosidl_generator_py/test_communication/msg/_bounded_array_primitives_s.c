...
#include <test_communication/msg/bounded_array_primitives__functions.h>
...
{
  test_communication__msg__BoundedArrayPrimitives * ros_message = test_communication__msg__BoundedArrayPrimitives__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "test_communication.msg._bounded_array_primitives.BoundedArrayPrimitives",
  ...
  size_t sizebool_values = PySequence_Size(pybool_values);
  if (!rosidl_generator_c__bool__Array__init(&(ros_message->bool_values), sizebool_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create bool__Array ros_message");
    return NULL;
  }
  bool * destbool_values = ros_message->bool_values.data;
  bool tmpbool_values;
  ...
  size_t sizebyte_values = PySequence_Size(pybyte_values);
  if (!rosidl_generator_c__byte__Array__init(&(ros_message->byte_values), sizebyte_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create byte__Array ros_message");
    return NULL;
  }
  uint8_t * destbyte_values = ros_message->byte_values.data;
  ...
  size_t sizechar_values = PySequence_Size(pychar_values);
  if (!rosidl_generator_c__char__Array__init(&(ros_message->char_values), sizechar_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create char__Array ros_message");
    return NULL;
  }
  signed char * destchar_values = ros_message->char_values.data;
  ...
  size_t sizefloat32_values = PySequence_Size(pyfloat32_values);
  if (!rosidl_generator_c__float32__Array__init(&(ros_message->float32_values), sizefloat32_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create float32__Array ros_message");
    return NULL;
  }
  float * destfloat32_values = ros_message->float32_values.data;
  ...
  size_t sizefloat64_values = PySequence_Size(pyfloat64_values);
  if (!rosidl_generator_c__float64__Array__init(&(ros_message->float64_values), sizefloat64_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create float64__Array ros_message");
    return NULL;
  }
  double * destfloat64_values = ros_message->float64_values.data;
  ...
  size_t sizeint8_values = PySequence_Size(pyint8_values);
  if (!rosidl_generator_c__int8__Array__init(&(ros_message->int8_values), sizeint8_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create int8__Array ros_message");
    return NULL;
  }
  int8_t * destint8_values = ros_message->int8_values.data;
  ...
  size_t sizeuint8_values = PySequence_Size(pyuint8_values);
  if (!rosidl_generator_c__uint8__Array__init(&(ros_message->uint8_values), sizeuint8_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create uint8__Array ros_message");
    return NULL;
  }
  uint8_t * destuint8_values = ros_message->uint8_values.data;
  ...
  size_t sizeint16_values = PySequence_Size(pyint16_values);
  if (!rosidl_generator_c__int16__Array__init(&(ros_message->int16_values), sizeint16_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create int16__Array ros_message");
    return NULL;
  }
  int16_t * destint16_values = ros_message->int16_values.data;
  ...
  size_t sizeuint16_values = PySequence_Size(pyuint16_values);
  if (!rosidl_generator_c__uint16__Array__init(&(ros_message->uint16_values), sizeuint16_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create uint16__Array ros_message");
    return NULL;
  }
  uint16_t * destuint16_values = ros_message->uint16_values.data;
  ...
  size_t sizeint32_values = PySequence_Size(pyint32_values);
  if (!rosidl_generator_c__int32__Array__init(&(ros_message->int32_values), sizeint32_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create int32__Array ros_message");
    return NULL;
  }
  int32_t * destint32_values = ros_message->int32_values.data;
  ...
  size_t sizeuint32_values = PySequence_Size(pyuint32_values);
  if (!rosidl_generator_c__uint32__Array__init(&(ros_message->uint32_values), sizeuint32_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create uint32__Array ros_message");
    return NULL;
  }
  uint32_t * destuint32_values = ros_message->uint32_values.data;
  ...
  size_t sizeint64_values = PySequence_Size(pyint64_values);
  if (!rosidl_generator_c__int64__Array__init(&(ros_message->int64_values), sizeint64_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create int64__Array ros_message");
    return NULL;
  }
  int64_t * destint64_values = ros_message->int64_values.data;
  ...
  size_t sizeuint64_values = PySequence_Size(pyuint64_values);
  if (!rosidl_generator_c__uint64__Array__init(&(ros_message->uint64_values), sizeuint64_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create uint64__Array ros_message");
    return NULL;
  }
  uint64_t * destuint64_values = ros_message->uint64_values.data;
  ...
  size_t sizestring_values = PySequence_Size(pystring_values);
  if (!rosidl_generator_c__String__Array__init(&(ros_message->string_values), sizestring_values)) {
    PyErr_SetString(PyExc_RuntimeError, "unable to create String__Array ros_message");
    return NULL;
  }
  rosidl_generator_c__String * deststring_values = ros_message->string_values.data;
  ...
  PyObject * pycheck = PyObject_GetAttrString(_pymsg, "check");
  assert(PyLong_Check(pycheck));
  ros_message->check = (int32_t)PyLong_AsLong(pycheck);
...
{
  test_communication__msg__BoundedArrayPrimitives * ros_message = (test_communication__msg__BoundedArrayPrimitives *)raw_ros_message;
  (void)ros_message;

  test_communication__msg__BoundedArrayPrimitives__destroy(ros_message);
}
...
PyObject * test_communication_bounded_array_primitives__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("test_communication.msg._bounded_array_primitives");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoundedArrayPrimitives");

  /* NOTE(esteve): Call constructor of BoundedArrayPrimitives */
  PyObject * _pymessage = NULL;
  _pymessage = PyObject_CallObject(pymessage_class, NULL);
  assert(_pymessage != NULL);

  PyObject * pybool_values = NULL;
  size_t sizebool_values = ros_message->bool_values.size;
  bool * tmpmessagedatabool_values = ros_message->bool_values.data;
  ...
  size_t sizebyte_values = ros_message->byte_values.size;
  uint8_t * tmpmessagedatabyte_values = ros_message->byte_values.data;
  ...
  size_t sizechar_values = ros_message->char_values.size;
  signed char * tmpmessagedatachar_values = ros_message->char_values.data;
  ...
  size_t sizefloat32_values = ros_message->float32_values.size;
  float * tmpmessagedatafloat32_values = ros_message->float32_values.data;
  ...
  size_t sizefloat64_values = ros_message->float64_values.size;
  double * tmpmessagedatafloat64_values = ros_message->float64_values.data;
  ...
  size_t sizeint8_values = ros_message->int8_values.size;
  int8_t * tmpmessagedataint8_values = ros_message->int8_values.data;
  ...
  size_t sizeuint8_values = ros_message->uint8_values.size;
  uint8_t * tmpmessagedatauint8_values = ros_message->uint8_values.data;
  ...
  size_t sizeint16_values = ros_message->int16_values.size;
  int16_t * tmpmessagedataint16_values = ros_message->int16_values.data;
  ...
  size_t sizeuint16_values = ros_message->uint16_values.size;
  uint16_t * tmpmessagedatauint16_values = ros_message->uint16_values.data;
  ...
  size_t sizeint32_values = ros_message->int32_values.size;
  int32_t * tmpmessagedataint32_values = ros_message->int32_values.data;
  ...
  size_t sizeuint32_values = ros_message->uint32_values.size;
  uint32_t * tmpmessagedatauint32_values = ros_message->uint32_values.data;
  ...
  size_t sizeint64_values = ros_message->int64_values.size;
  int64_t * tmpmessagedataint64_values = ros_message->int64_values.data;
  ...
  size_t sizeuint64_values = ros_message->uint64_values.size;
  uint64_t * tmpmessagedatauint64_values = ros_message->uint64_values.data;
  ...
  size_t sizestring_values = ros_message->string_values.size;
  rosidl_generator_c__String * tmpmessagedatastring_values = ros_message->string_values.data;
  ...
  PyObject * pycheck = NULL;
  pycheck = PyLong_FromLong(ros_message->check);
  assert(pycheck != NULL);
  Py_INCREF(pycheck);
  PyObject_SetAttrString(_pymessage, "check", pycheck);
  assert(_pymessage != NULL);
  return _pymessage;
}
