...
{
  test_communication__msg__StaticArrayNested * ros_message = test_communication__msg__StaticArrayNested__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "test_communication.msg._static_array_nested.StaticArrayNested",
  ...
  size_t sizeprimitive_values = 4;
  test_communication__msg__Primitives * destprimitive_values = ros_message->primitive_values;
...
{
  test_communication__msg__StaticArrayNested * ros_message = (test_communication__msg__StaticArrayNested *)raw_ros_message;
  (void)ros_message;

  test_communication__msg__StaticArrayNested__destroy(ros_message);
}
...
PyObject * test_communication_static_array_nested__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("test_communication.msg._static_array_nested");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StaticArrayNested");

  /* NOTE(esteve): Call constructor of StaticArrayNested */
  ...
  size_t idxprimitive_values;
  for (idxprimitive_values = 0; idxprimitive_values < sizeprimitive_values; idxprimitive_values++) {
    itemprimitive_values = ros_message->primitive_values[idxprimitive_values];
