...
{
  test_communication__srv__Primitives_Request * ros_message = test_communication__srv__Primitives_Request__create();
  (void)ros_message;
  ...
  assert(strncmp(
      "test_communication.srv._primitives__request.Primitives_Request",
...
{
  test_communication__srv__Primitives_Request * ros_message = (test_communication__srv__Primitives_Request *)raw_ros_message;
  (void)ros_message;

  test_communication__srv__Primitives_Request__destroy(ros_message);
}
...
PyObject * test_communication_primitives__request__convert_to_py(void * raw_ros_message)
{
  ...
  PyObject * pymessage_module = PyImport_ImportModule("test_communication.srv._primitives__request");
  PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Primitives_Request");

  /* NOTE(esteve): Call constructor of Primitives_Request */
