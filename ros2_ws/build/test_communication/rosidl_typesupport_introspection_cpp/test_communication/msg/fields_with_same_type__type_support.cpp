...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FieldsWithSameType_message_member_array[2] = {
  {
    ...
    offsetof(test_communication::msg::FieldsWithSameType, primitive_values1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_communication::msg::FieldsWithSameType, primitive_values2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
