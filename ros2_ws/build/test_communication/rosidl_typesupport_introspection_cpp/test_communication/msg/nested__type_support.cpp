...
#include "test_communication/msg/nested__struct.hpp"
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Nested_message_member_array[1] = {
  {
    ...
    offsetof(test_communication::msg::Nested, primitive_values),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Nested_message_members = {
  ...
  "Nested",  // message name
  1,  // number of fields
  sizeof(test_communication::msg::Nested),
...
get_message_type_support_handle<test_communication::msg::Nested>()
{
  return &::test_communication::msg::rosidl_typesupport_introspection_cpp::Nested_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_communication, msg, Nested)() {
  return &::test_communication::msg::rosidl_typesupport_introspection_cpp::Nested_message_type_support_handle;
}
