...
nav_msgs__srv__GetPlan_Response__init(nav_msgs__srv__GetPlan_Response * msg)
{
  ...
  // plan
  nav_msgs__msg__Path__init(&msg->plan);
  return true;
}
...
{
  nav_msgs__srv__GetPlan_Response__Array * array = (nav_msgs__srv__GetPlan_Response__Array *)malloc(sizeof(nav_msgs__srv__GetPlan_Response__Array));
  if (!array) {
    return NULL;
  }
  bool success = nav_msgs__srv__GetPlan_Response__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    nav_msgs__srv__GetPlan_Response__Array__fini(array);
  }
  free(array);
}
