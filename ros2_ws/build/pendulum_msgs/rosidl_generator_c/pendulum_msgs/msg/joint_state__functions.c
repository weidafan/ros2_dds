...
bool
pendulum_msgs__msg__JointState__Array__init(pendulum_msgs__msg__JointState__Array * array, size_t size)
{
  if (!array) {
    return false;
  }
...
void
pendulum_msgs__msg__JointState__Array__fini(pendulum_msgs__msg__JointState__Array * array)
{
  if (!array) {
    return;
  }
...
pendulum_msgs__msg__JointState__Array__create(size_t size)
{
  pendulum_msgs__msg__JointState__Array * array = (pendulum_msgs__msg__JointState__Array *)malloc(sizeof(pendulum_msgs__msg__JointState__Array));
  if (!array) {
    return NULL;
  }
  bool success = pendulum_msgs__msg__JointState__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
pendulum_msgs__msg__JointState__Array__destroy(pendulum_msgs__msg__JointState__Array * array)
{
  if (array) {
    pendulum_msgs__msg__JointState__Array__fini(array);
  }
  free(array);
}
