...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_package/environment/ament_prefix_path.sh:$AMENT_CURRENT_PREFIX/share/ament_package/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_package/environment/pythonpath.sh"
